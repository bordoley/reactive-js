(function (React, ReactDOMClient) {
     ...
     */
    const pipeSome = (source, ...operators) => isSome(source) ? pipeUnsafe(source, ...operators) : none;
    const error = (message) => {
    ...
    /** @type {unique symbol} */
    const __EventPublisherLike_listenerCount = /*@__PURE__*/ symbol("EventPublisherLike_listenerCount");
    /** @type {unique symbol} */
    const __EventSourceLike_addListener = /*@__PURE__*/ symbol("EventSourceLike_addListener");
    /** @type {unique symbol} */
    ...
    /** @type {unique symbol} */
    const __PredicatedLike_predicate = /*@__PURE__*/ symbol("PredicatedLike_predicate");
    /** @type {unique symbol} */
    const __CreateEventSource_createDelegate = /*@__PURE__*/ symbol("CreateEventSource_createDelegate");
    /** @type {unique symbol} */
    const __Enumerator_private_current = /*@__PURE__*/ symbol("Enumerator_private_current");
    /** @type {unique symbol} */
    const __EventPublisher_listeners = /*@__PURE__*/ symbol("EventPublisher_listeners");
    /** @type {unique symbol} */
    ...
    const EventPublisher_createRefCounted = /*@__PURE__*/ (() => {
        const createRefCountedEventPublisherInstance = createInstanceFactory(mix(include(Disposable_delegatingMixin, Delegating_mixin()), function RefCountedEventPublisher(instance, delegate) {
            ...
            get [__EventPublisherLike_listenerCount]() {
                return this[__DelegatingLike_delegate][__EventPublisherLike_listenerCount];
            },
            [__EventListenerLike_notify](next) {
                this[__DelegatingLike_delegate][__EventListenerLike_notify](next);
            },
            [__EventSourceLike_addListener](listener) {
                this[__DelegatingLike_delegate][__EventSourceLike_addListener](listener);
    ...
    const IndexedBufferCollection_createWithMutableDelegate = /*@__PURE__*/ (() => createInstanceFactory(mix(include(Delegating_mixin()), function MutableDelegatingIndexedBufferCollection(instance, options) {
        ...
        [__KeyedCollectionLike_get](index) {
            return this[__DelegatingLike_delegate][__KeyedCollectionLike_get](index);
        },
    })))();
    ...
    const EventSource_create = /*@__PURE__*/ (() => {
        return createInstanceFactory(mix(include(Delegating_mixin()), function CreateEventSource(instance, setup, options = {}) {
            ...
            instance[__CreateEventSource_createDelegate] = () => {
                ...
                instance[__ReplayableLike_buffer][__DelegatingLike_delegate] = buffer;
                return delegate;
            };
            return instance;
        }, props({
            ...
            [__EventSourceLike_addListener](listener) {
                const delegate = this[__DelegatingLike_delegate] ??
    ...
    class LiftedEventSource {
        ...
        [__EventSourceLike_addListener](listener) {
            pipeUnsafe(listener, ...this[__LiftedLike_operators], bindMethod(this[__LiftedLike_source], __EventSourceLike_addListener));
        }
    }
    ...
    const EventSource_map = /*@__PURE__*/ (() => {
        const createMapEventListener = (() => createInstanceFactory(mix(include(Disposable_delegatingMixin, Delegating_mixin()), function MapEventListener(instance, delegate, selector) {
            ...
            [__EventListenerLike_notify](next) {
                ...
                this[__DelegatingLike_delegate][__EventListenerLike_notify](mapped);
            },
        })))();
    ...
    /*@__PURE__*/ (() => {
        ...
        return (root = document, options) => child => create(listener => {
            const publisher = eventPublishers.get(root)?.get(child) ??
                (() => {
                    ...
                    return pipe(publisher, onDisposed(() => {
                        const intersectionObserver = intersectionObservers.get(root);
    ...
    const useEventSource = (eventSourceOrFactory, depsOrNone) => {
        ...
        React.useEffect(() => {
            const listener = pipe(create$1(v => updateState(_ => v)), onError(updateError));
    ...
    const IntersectionApp = () => {
        ...
        useEventSource(() => {
            var _a;
            return (_a = pipeSome(endOfPageRef, intersectionWith(document, { replay: 1 }), pick("isIntersecting"), keep(isTrue), forEach(pipeLazy(incrementBy(10), updateCount)), ignoreElements())) !== null && _a !== void 0 ? _a : empty();
        }, [endOfPageRef]);
        return (React.createElement("div", { style: {
            ...
            Array(count)
                .fill(none)
                .map((_, i) => (React.createElement("div", { key: i, style: {
                    background: "#FFF",
            ...
            React.createElement("div", { ref: setEndOfPage, style: {
                    width: "1px",
                    height: "1px",
                } })));
    };
    const rootElement = document.getElementById("root");
    ReactDOMClient.createRoot(rootElement).render(React.createElement(IntersectionApp, null));
