...
import { describe, testAsync, expectEquals, expectPromiseToThrow, } from "../lib/experimental/testing.js";
...
import { toPromise, takeFirst } from "../lib/observable.js";
...
export const tests = describe("node", describe("createWritableIOSink", testAsync("sinking to writable", async () => {
    ...
    const src = pipe([encoder.encode("abc"), encoder.encode("defg")], fromArray());
