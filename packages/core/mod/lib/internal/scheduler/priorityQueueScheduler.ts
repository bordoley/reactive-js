...
import { schedule, scheduleWithPriority } from "./schedule.ts";
...
class PrioritySchedulerContinuation extends AbstractSchedulerContinuation implements SchedulerLike {
