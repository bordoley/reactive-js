...
export { every, none } from "./internal/enumerable/every";
export { first } from "./internal/enumerable/first";
export { flatten, flatMap } from "./internal/enumerable/flatten";
...
export { some, contains } from "./internal/enumerable/some";
