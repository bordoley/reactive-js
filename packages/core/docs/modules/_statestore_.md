...
▸ **toStateStore**<**T**>(`equality`: referenceEquality): *[StreamableOperator](_streamable_.md#streamableoperator)‹T, T, [StateUpdater](_statestore_.md#stateupdater)‹T›, T›*
...
Name | Type | Default |
------ | ------ | ------ |
`equality` | referenceEquality | referenceEquality |
