...
import { observe, Notification, Notifications, Observable, ObservableLike } from '@rx-min/rx-core';

export const useObservable = <T>(observable: ObservableLike<T>): T | undefined => {
