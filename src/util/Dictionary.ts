...
export const empty: Empty<DictionaryLike>["empty"] = Dictionary_empty;
export const entries: Entries<DictionaryLike>["entries"] = Dictionary_entries;
export const keys: Keys<DictionaryLike>["keys"] = Dictionary_keys;
export const values: Values<DictionaryLike>["values"] = Dictionary_values;
