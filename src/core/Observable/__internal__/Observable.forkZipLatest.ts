...
const Observable_forkZipLatest: ReactiveContainer.ForkZipLatest<ObservableContainer>["forkZipLatest"] =
  (<T>(
    ...
    (obs: ObservableLike<T>) =>
      Observable_latest(
        ...
        2,
      )) as ReactiveContainer.ForkZipLatest<ObservableContainer>["forkZipLatest"];
