...
interface NewInstanceWith {
  ...
  newInstanceWith<T, TA, TB>(
    a: TA,
    b: TB,
  ): Function1<Constructor2<TA, TB, T>, T>;
  newInstanceWith<T, TA, TB, TC>(
    a: TA,
    b: TB,
    c: TC,
  ): Function1<Constructor3<TA, TB, TC, T>, T>;
  newInstanceWith<T, TA, TB, TC, TD>(
    a: TA,
    b: TB,
    c: TC,
    d: TD,
...
export const newInstanceWith: NewInstanceWith["newInstanceWith"] =
  (
    ...args: readonly any[]
...
interface InstanceFactory {
  ...
  instanceFactory<T, TA, TB>(
    Constructor: Constructor2<TA, TB, T>,
  ): Function2<TA, TB, T>;
  instanceFactory<T, TA, TB, TC>(
    Constructor: Constructor3<TA, TB, TC, T>,
  ): Function3<TA, TB, TC, T>;
}

export const instanceFactory: InstanceFactory["instanceFactory"] =
  (Constructor: new (...args: readonly any[]) => any) =>
  (...args: readonly any[]) =>
    _newInstance(Constructor, ...args);
