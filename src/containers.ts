...
export interface ContainerTypeClass<C extends Container> {
  ...
  zipWith<TA, TB, TC, TD, TE, TF, TG, TH, TI>(
    ...
    h: Containers.Of<C, TH>,
    i: Containers.Of<C, TI>,
  ): Containers.Operator<C, TA, readonly [TA, TB, TC, TD, TE, TF, TG, TH, TI]>;
}
...
export interface KeyedContainerTypeClass<C extends KeyedContainers> {
   ...
   * @category Operator
   */
  forEach<T, TKey extends KeyedContainers.KeyOf<C> = KeyedContainers.KeyOf<C>>(
   ...
   * @category Operator
   */
  map<TA, TB, TKey extends KeyedContainers.KeyOf<C> = KeyedContainers.KeyOf<C>>(
