...
export const last: Signature["last"] = Observable.last;
...
export const reduce: Signature["reduce"] = Observable.reduce;
...
export const toRunnable: Signature["toRunnable"] = Observable.toRunnable;
