...
export const ContinuationSchedulerInstanceLike_scheduleContinuation = Symbol(
  "ContinContinuationSchedulerInstanceLike_scheduleContinuationuationSchedulerDelegateLike_shouldYield",
);

type ContinuationSchedulerMixinInstanceBase = Pick<
  SchedulerLike,
  typeof SchedulerLike_now
>;
export interface ContinuationSchedulerInstanceLike
  extends ContinuationSchedulerMixinInstanceBase {
...
export interface ContinuationSchedulerMixinLike
  extends ContinuationSchedulerInstanceLike,
    ContinuationSchedulerLike,
    DisposableLike {
  [ContinuationSchedulerMixinLike_runContinuation](
    continuation: ContinuationLike,
...
> = /*@__PURE__*/ (() => {
  ...
  return mix<
    Function2<
      ...
      number,
      ContinuationSchedulerMixinLike & ContinuationSchedulerInstanceLike
    >,
    ...
    Omit<
      ...
      | keyof ContinuationSchedulerInstanceLike
    >,
    ContinuationSchedulerInstanceLike
  >(
    ...
    }),
    {
      ...
      [ContinuationSchedulerLike_schedule](
        ...
        if (
          ...
          this[ContinuationSchedulerInstanceLike_scheduleContinuation](
            continuation,
            delay,
          );
        } else {
