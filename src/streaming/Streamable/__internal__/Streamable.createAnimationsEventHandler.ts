...
) => AnimationsEventHandlerStreamLike<TEventType, T, TKey> & DisposableLike =
  /*@__PURE__*/ (<
    TEventType,
    T,
...
const Streamable_createAnimationsEventHandler: CreateAnimationsEventHandler["createAnimationsEventHandler"] =
  (<
    TEventType = unknown,
    T = number,
    TKey extends string | symbol | number = string,
  >(
    ...
    [StreamableLike_stream]: (scheduler, options) =>
      createAnimationsEventHandlerStream(
        animations,
        createOptions,
        scheduler,
        options,
      ),
  })) as CreateAnimationsEventHandler["createAnimationsEventHandler"];
