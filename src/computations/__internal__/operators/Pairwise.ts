...
export const createListener: <T>(
  ...
  mixInstanceFactory(
    ...
    function PairwiseListener(
      ...
      init(LiftedListenerMixin<T, Tuple2<T, T>>(), this, delegate, none);
  ...
  /*@__PURE__*/ (<T>() =>
    mixInstanceFactory(
      ...
      function PairwiseSink(
        ...
        init(LiftedSinkMixin<T, Tuple2<T, T>>(), this, delegate, none);
        init(PairwiseMixin(), this);
...
export const createConsumer: <T>(
  ...
  mixInstanceFactory(
    ...
    function PairwiseConsumer(
      ...
      init(LiftedConsumerMixin<T, Tuple2<T, T>>(), this, delegate, none);
      init(PairwiseMixin(), this);
