...
| Name | Type |
| :------ | :------ |
| `op` | [`Function1`](../modules/functions.md#function1)<[`DeferredSideEffectsObservableLike`](concurrent.DeferredSideEffectsObservableLike.md)<`TReq`\>, [`DeferredObservableLike`](concurrent.DeferredObservableLike.md)<`T`\>\> |
