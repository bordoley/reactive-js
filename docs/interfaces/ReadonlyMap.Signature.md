...
- [`KeyedContainerTypeClass`](type_classes.KeyedContainerTypeClass.md)<[`Type`](ReadonlyMap.Type.md)\>
...
- [fromReadonlyArray](ReadonlyMap.Signature.md#fromreadonlyarray)

### Operator Methods

- [forEach](ReadonlyMap.Signature.md#foreach)
- [forEachWithKey](ReadonlyMap.Signature.md#foreachwithkey)
- [identity](ReadonlyMap.Signature.md#identity)
...
- [toReadonlyArray](ReadonlyMap.Signature.md#toreadonlyarray)
...
▸ **identity**<`T`, `TKey`\>(): [`KeyedContainerOperator`](../modules/types.md#keyedcontaineroperator)<[`Type`](ReadonlyMap.Type.md), `TKey`, `T`, `T`\>
