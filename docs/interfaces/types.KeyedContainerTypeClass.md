[Reactive-JS](../README.md) / [types](../modules/types.md) / KeyedContainerTypeClass

# Interface: KeyedContainerTypeClass<C, TKeyBase\>

[types](../modules/types.md).KeyedContainerTypeClass
...
- **`KeyedContainerTypeClass`**
  ...
  ↳ [`ConcreteKeyedContainerTypeClass`](types.ConcreteKeyedContainerTypeClass.md)

  ↳ [`AssociativeKeyedContainerTypeClass`](types.AssociativeKeyedContainerTypeClass.md)

## Table of contents

### Operator Methods

- [forEach](types.KeyedContainerTypeClass.md#foreach)
- [forEachWithKey](types.KeyedContainerTypeClass.md#foreachwithkey)

### Transform Methods

- [entries](types.KeyedContainerTypeClass.md#entries)
- [reduce](types.KeyedContainerTypeClass.md#reduce)
- [reduceWithKey](types.KeyedContainerTypeClass.md#reducewithkey)
- [values](types.KeyedContainerTypeClass.md#values)
