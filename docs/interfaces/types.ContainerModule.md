...
- **`ContainerModule`**
  ...
  ↳ [`DeferredContainerModule`](types.DeferredContainerModule.md)
...
- [pairwise](types.ContainerModule.md#pairwise)
- [pick](types.ContainerModule.md#pick)
- [scan](types.ContainerModule.md#scan)
- [skipFirst](types.ContainerModule.md#skipfirst)
