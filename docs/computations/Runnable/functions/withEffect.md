...
[Reactive-JS](../../../README.md) / [computations/Runnable](../README.md) / withEffect

# Function: withEffect()

> **withEffect**\<`T`\>(`effect`): [`ComputationOperatorWithSideEffects`](../../type-aliases/ComputationOperatorWithSideEffects.md)\<[`RunnableComputation`](../interfaces/RunnableComputation.md), `T`, `T`\>
