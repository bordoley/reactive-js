...
• **teardown**: [`SideEffect`](../../../functions/type-aliases/SideEffect.md)
...
• **teardown**: [`SideEffect1`](../../../functions/type-aliases/SideEffect1.md)\<`Error`\>
...
• **disposable**: [`DisposableContainerLike`](../../interfaces/DisposableContainerLike.md)
