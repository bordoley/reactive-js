...
- [IndexedQueueLike](interfaces/IndexedQueueLike.md)
...
- [StackLike](interfaces/StackLike.md)
...
- [IndexedQueueLike\_get](variables/IndexedQueueLike_get.md)
- [IndexedQueueLike\_set](variables/IndexedQueueLike_set.md)
...
- [StackLike\_head](variables/StackLike_head.md)
- [StackLike\_pop](variables/StackLike_pop.md)
