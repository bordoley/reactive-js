...
- [CollectionOf](type-aliases/CollectionOf.md)
- [CollectionOperator](type-aliases/CollectionOperator.md)
- [KeyOf](type-aliases/KeyOf.md)
- [ReadonlyObjectMapLike](type-aliases/ReadonlyObjectMapLike.md)

### Variables

- [Collection\_T](variables/Collection_T.md)
- [Collection\_TKey](variables/Collection_TKey.md)
...
- [EnumerableLike\_enumerate](variables/EnumerableLike_enumerate.md)
...
- [EnumeratorLike\_isCompleted](variables/EnumeratorLike_isCompleted.md)
- [EnumeratorLike\_move](variables/EnumeratorLike_move.md)
