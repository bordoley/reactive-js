...
- [clampPositiveInteger](functions/clampPositiveInteger.md)
- [clampPositiveNonZeroInteger](functions/clampPositiveNonZeroInteger.md)
- [decrement](functions/decrement.md)
- [decrementBy](functions/decrementBy.md)
- [floor](functions/floor.md)
- [increment](functions/increment.md)
- [incrementBy](functions/incrementBy.md)
