[Reactive-JS](../README.md) / core/Observable/effects

# Module: core/Observable/effects

## Table of contents

### Functions

- [\_\_await](core_Observable_effects.md#__await)
- [\_\_bind](core_Observable_effects.md#__bind)
- [\_\_bindMethod](core_Observable_effects.md#__bindmethod)
- [\_\_constant](core_Observable_effects.md#__constant)
- [\_\_currentScheduler](core_Observable_effects.md#__currentscheduler)
- [\_\_do](core_Observable_effects.md#__do)
- [\_\_memo](core_Observable_effects.md#__memo)
- [\_\_observe](core_Observable_effects.md#__observe)
- [\_\_state](core_Observable_effects.md#__state)
- [\_\_stream](core_Observable_effects.md#__stream)
- [\_\_using](core_Observable_effects.md#__using)
...
▸ **__currentScheduler**(): [`SchedulerLike`](../interfaces/core.SchedulerLike.md)
...
▸ **__state**<`T`\>(`initialState`, `options?`): [`StreamLike`](../interfaces/core.StreamLike.md)<[`Updater`](functions.md#updater)<`T`\>, `T`\>
...
[`StreamLike`](../interfaces/core.StreamLike.md)<[`Updater`](functions.md#updater)<`T`\>, `T`\>

___

### \_\_stream

▸ **__stream**<`TStreamable`\>(`streamable`, `«destructured»?`): [`StreamOf`](core.md#streamof)<`TStreamable`\>
...
[`StreamOf`](core.md#streamof)<`TStreamable`\>
