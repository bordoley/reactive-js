...
▸ **useAnimate**<`TElement`, `T`, `TEvent`\>(`value`, `selector`, `deps?`): `Ref`<`TElement`\>
...
| Name | Type |
| :------ | :------ |
| `value` | [`Optional`](functions.md#optional)<[`EventSourceLike`](../interfaces/util.EventSourceLike.md)<{ `event`: `TEvent` ; `value`: `T`  }\>\> |
