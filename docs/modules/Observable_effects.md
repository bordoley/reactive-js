[Reactive-JS](../README.md) / Observable/effects

# Module: Observable/effects
...
- [\_\_do](Observable_effects.md#__do)
- [\_\_memo](Observable_effects.md#__memo)
- [\_\_observe](Observable_effects.md#__observe)
- [\_\_state](Observable_effects.md#__state)
- [\_\_stream](Observable_effects.md#__stream)
- [\_\_using](Observable_effects.md#__using)
...
▸ **__currentScheduler**(): [`SchedulerLike`](../interfaces/types.SchedulerLike.md)
...
▸ **__state**<`T`\>(`initialState`, `options?`): [`StreamLike`](../interfaces/types.StreamLike.md)<[`Updater`](functions.md#updater)<`T`\>, `T`\>
...
[`StreamLike`](../interfaces/types.StreamLike.md)<[`Updater`](functions.md#updater)<`T`\>, `T`\>

___

### \_\_stream

▸ **__stream**<`TStreamable`\>(`streamable`, `«destructured»?`): [`StreamOf`](types.md#streamof)<`TStreamable`\>
...
[`StreamOf`](types.md#streamof)<`TStreamable`\>
