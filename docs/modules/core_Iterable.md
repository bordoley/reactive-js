...
▸ **identity**<`T`\>(): [`Operator`](core.Container.md#operator)<[`IterableContainer`](../interfaces/core.IterableContainer.md), `T`, `T`\>
...
[`Operator`](core.Container.md#operator)<[`IterableContainer`](../interfaces/core.IterableContainer.md), `T`, `T`\>
