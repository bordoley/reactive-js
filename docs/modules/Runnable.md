...
▸ **distinctUntilChanged**<`T`\>(`options?`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `T`\>
...
▸ **forEach**<`T`\>(`effect`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `T`\>
...
▸ **keep**<`T`\>(`predicate`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `T`\>
...
▸ **map**<`TA`, `TB`\>(`selector`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `TA`, `TB`\>
...
▸ **mapTo**<`TA`, `TB`\>(`value`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `TA`, `TB`\>
...
▸ **pairwise**<`T`\>(): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, readonly [`T`, `T`]\>
...
▸ **scan**<`T`, `TAcc`\>(`scanner`, `initialValue`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `TAcc`\>
...
[`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `TAcc`\>

___

### skipFirst

▸ **skipFirst**<`T`\>(`options?`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `T`\>
...
▸ **takeLast**<`T`\>(`options?`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `T`\>
...
▸ **takeWhile**<`T`\>(`predicate`, `options?`): [`ContainerOperator`](types.md#containeroperator)<[`Type`](../interfaces/Runnable.Type.md), `T`, `T`\>
