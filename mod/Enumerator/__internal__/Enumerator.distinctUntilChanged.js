...
/*@__PURE__*/ (() => {
    const createDistinctUntilChangedEnumerator = createInstanceFactory(mix(include(Delegating_mixin()), function DistinctUntilChangedEnumerator(instance, delegate, equality) {
