/// <reference types="./ReplayPublisher.test.d.ts" />
...
import { ObservableLike_observe, ReplayPublisherLike_observerCount, SchedulerLike_schedule, VirtualTimeSchedulerLike_run, } from "../../concurrent.js";
...
testModule("ReplayPublisher", describe("create", test("with replay", () => {
    const scheduler = VirtualTimeScheduler.create();
    const publisher = ReplayPublisher.create({ replay: 2 });
