/// <reference types="./HostScheduler.test.d.ts" />
...
testModule("HostScheduler", testAsync("delayed continuation", Disposable.usingAsyncLazy(HostScheduler.create)(async (scheduler) => {
