...
export declare const create: (scheduler: QueueableContinuationSchedulerLike, effect: SideEffect1<ContinuationContextLike>, dueTime: number) => QueueableContinuationLike;
