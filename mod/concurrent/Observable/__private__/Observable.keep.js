...
const createKeepObserver = /*@__PURE__*/ (() => createInstanceFactory(decorateNotifyWithObserverStateAssert(mix(include(ObserverMixin(), KeepSinkMixin()), function KeepObserver(instance, delegate, predicate) {
