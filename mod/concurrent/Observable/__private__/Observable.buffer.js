...
const Observer_createBufferObserver = /*@__PURE__*/ (() => createInstanceFactory(mix(include(ObserverMixin(), decorateNotifyWithObserverStateAssert(BufferSinkMixin())), function BufferObserver(instance, delegate, count) {
