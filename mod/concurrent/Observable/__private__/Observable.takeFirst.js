...
const Observer_createTakeFirstObserver = /*@__PURE__*/ (() => createInstanceFactory(decorateNotifyWithObserverStateAssert(mix(include(ObserverMixin(), TakeFirstSinkMixin()), function TakeFirstObserver(instance, delegate, takeCount) {
