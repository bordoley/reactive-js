...
const Observer_createSkipFirstObserver = /*@__PURE__*/ (() => createInstanceFactory(decorateNotifyWithObserverStateAssert(mix(include(ObserverMixin(), SkipFirstSinkMixin()), function SkipFirstObserver(instance, delegate, skipCount) {
