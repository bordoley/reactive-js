...
const Using = 4;
const Constant = 5;
const __AwaitOrObserveEffect_hasValue = Symbol("__AwaitOrObserveEffect_hasValue");
const __AwaitOrObserveEffect_observable = Symbol("__AwaitOrObserveEffect_observable");
const __AwaitOrObserveEffect_subscription = Symbol("__AwaitOrObserveEffect_subscription");
const __AwaitOrObserveEffect_value = Symbol("__AwaitOrObserveEffect_value");
const __ComputeContext_awaitOrObserve = Symbol("__ComputeContext_awaitOrObserve");
...
const __ComputeContext_observableConfig = Symbol("__ComputeContext_observableConfig");
const __ComputeContext_observer = Symbol("__ComputeContext_observer");
const __ComputeContext_runComputation = Symbol("__ComputeContext_runComputation");
const __ComputeContext_scheduledComputationSubscription = Symbol("__ComputeContext_scheduledComputationSubscription");
...
class ComputeContext {
    ...
    [__ComputeContext_scheduledComputationSubscription] = Disposable.disposed;
    ...
    [__ComputeContext_awaitOrObserve](observable, shouldAwait) {
        ...
        if (effect[__AwaitOrObserveEffect_observable] === observable) {
            ...
            }), Observable_subscribeWithConfig(observer, observer), Disposable.addTo(observer), Disposable.onComplete(this[__ComputeContext_cleanup]));
    ...
    [__ComputeContext_memoOrUse](shouldUse, f, ...args) {
        ...
        if (f === effect[__MemoOrUsingEffect_func] &&
            ...
            if (shouldUse) {
                pipe(value, Disposable.addTo(this[__ComputeContext_observer]));
            }
            return value;
        }
    }
