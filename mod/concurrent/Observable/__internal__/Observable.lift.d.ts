...
import type { DeferredObservableOperator, ObservableOperatorWithSideEffects, PureObservableOperator } from "../../Observable.js";
interface ObservableLift {
    lift(options: Pick<RunnableLike, typeof ObservableLike_isDeferred | typeof ObservableLike_isPure | typeof ObservableLike_isRunnable>): <TA, TB>(operator: Function1<ObserverLike<TB>, ObserverLike<TA>>) => PureObservableOperator<TA, TB>;
    ...
    lift(options: Pick<DeferredObservableLike, typeof ObservableLike_isDeferred | typeof ObservableLike_isPure | typeof ObservableLike_isRunnable>): <TA, TB>(operator: Function1<ObserverLike<TB>, ObserverLike<TA>>) => DeferredObservableOperator<TA, TB>;
