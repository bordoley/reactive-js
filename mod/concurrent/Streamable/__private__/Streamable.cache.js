/// <reference types="./Streamable.cache.d.ts" />
...
const Streamable_cache = (persistentStore, options = {}) => ({
    [StreamableLike_stream]: (scheduler, streamOptions) => cacheStream(scheduler, streamOptions, options.capacity ?? MAX_SAFE_INTEGER, options.cleanupScheduler ?? scheduler, persistentStore),
});
