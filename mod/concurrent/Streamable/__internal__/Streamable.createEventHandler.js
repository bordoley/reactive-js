...
const Streamable_createEventHandler = ((op, options = {}) => {
    ...
    return Streamable_create(compose(mode === "switching"
        ...
        : mode === "blocking"
            ...
            : Observable_mergeMap(compose(op, Observable_ignoreElements(), Observable_startWith(true), Observable_endWith(false)), { ...options, concurrency: 1 }), Observable_mergeWith(pipe(false, Observable_fromOptional()))));
});
