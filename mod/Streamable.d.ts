 ...
 */
export declare const create: <TReq, T>(op: import("./containers.js").Container.Operator<import("./containers.js").DeferredObservableContainer.Type, TReq, T>) => import("./types.js").StreamableLike<TReq, T, import("./types.js").StreamLike<TReq, T>>;
/**
 * @category Constructor
 */
