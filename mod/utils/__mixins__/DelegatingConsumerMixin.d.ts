...
declare const DelegatingConsumerMixin: <T, TDelegateConsumer extends ConsumerLike<T> = ConsumerLike<T>>() => Mixin1<Omit<DelegatingConsumerLike<T, TDelegateConsumer>, keyof DisposableLike>, TDelegateConsumer>;
