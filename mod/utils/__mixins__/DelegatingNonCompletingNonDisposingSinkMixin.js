/// <reference types="./DelegatingNonCompletingNonDisposingSinkMixin.d.ts" />
...
const DelegatingNonCompletingNonDisposingSinkMixin = /*@__PURE__*/ (() => {
    return returns(mix(include(DisposableMixin, DelegatingSinkMixin()), function DelegatingNonCompletingNonDisposingSinkMixin(delegate) {
