...
declare const DelegatingSinkMixin: <T, TDelegateSink extends SinkLike<T> = SinkLike<T>>() => Mixin1<Omit<DelegatingSinkLike<T, TDelegateSink>, keyof DisposableLike>, TDelegateSink>;
