...
declare const DelegatingCatchErrorConsumerMixin: <T, TOut = T, TDelegateConsumer extends ConsumerLike<TOut> = ConsumerLike<TOut>>() => Mixin1<TReturn<T, TOut, TDelegateConsumer>, TDelegateConsumer>;
