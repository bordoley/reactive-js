...
interface LiftedSinkMixinModule {
    <TA, TB = TA, TDelegateSink extends SinkLike<TB> = SinkLike<TB>>(): Mixin1<LiftedSinkLike<TA, TB, TDelegateSink>, TDelegateSink, Pick<LiftedSinkLike<TA, TB, TDelegateSink>, keyof DisposableLike>>;
    <T, TDelegateSink extends SinkLike<T> = SinkLike<T>>(): Mixin1<LiftedSinkLike<T, T, TDelegateSink>, TDelegateSink, Pick<LiftedSinkLike<T, T, TDelegateSink>, keyof DisposableLike | typeof LiftedEventListenerLike_notify>>;
}
