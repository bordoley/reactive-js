/// <reference types="./BufferSinkMixin.d.ts" />
...
const BufferSinkMixin = /*@__PURE__*/ (() => returns(mix(include(DisposableMixin), function BufferSinkMixin(instance, delegate, count, onComplete) {
