...
declare const DelegatingNonCompletingNonDisposingMixin: <T, TOut = T, TDelegateSink extends SinkLike<TOut> = SinkLike<TOut>>() => Mixin1<TReturn<T, TOut, TDelegateSink>, TDelegateSink, TPrototype<T, TOut, TDelegateSink>>;
