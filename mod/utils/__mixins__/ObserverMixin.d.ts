...
type TPrototype<TConsumer extends ConsumerLike, T> = Omit<ObserverLike<T> & ConsumerMixinLike<TConsumer, T>, keyof DisposableLike | keyof SchedulerLike | keyof FlowControllerLike | typeof SinkLike_isCompleted | typeof ConsumerMixinLike_consumer>;
