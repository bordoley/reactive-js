...
import { ContinuationContextLike_yield, DisposableContainerLike_add, DisposableLike_isDisposed, PauseableLike_isPaused, PauseableLike_pause, PauseableLike_resume, QueueLike_dequeue, QueueLike_head, SchedulerLike_inContinuation, SchedulerLike_maxYieldInterval, SchedulerLike_now, SchedulerLike_schedule, SchedulerLike_shouldYield, SerialDisposableLike_current, SinkLike_push, } from "../utils.js";
...
export const create = /*@PURE__*/ (() => {
    ...
    return mixInstanceFactory(include(SchedulerMixin, SerialDisposableMixin(), QueueMixin()), function PauseableScheduler(host) {
        ...
        [SchedulerMixinHostLike_schedule](continuation) {
            this[SinkLike_push](continuation);
            scheduleOnHost(this);
        },
    });
})();
