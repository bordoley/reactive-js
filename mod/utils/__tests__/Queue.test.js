...
import { CollectionEnumeratorLike_count, CollectionEnumeratorLike_peek, DisposableLike_dispose, EnumeratorLike_current, QueueableLike_enqueue, SyncEnumeratorLike_moveNext, } from "../../utils.js";
...
testModule("Queue", test("enqueue", () => {
    ...
    pipe((queue[SyncEnumeratorLike_moveNext](), queue[EnumeratorLike_current]), expectEquals(0));
    pipe(queue[CollectionEnumeratorLike_peek], expectEquals(1));
    pipe((queue[SyncEnumeratorLike_moveNext](), queue[EnumeratorLike_current]), expectEquals(1));
    pipe(queue[CollectionEnumeratorLike_peek], expectEquals(2));
    pipe((queue[SyncEnumeratorLike_moveNext](), queue[EnumeratorLike_current]), expectEquals(2));
    pipe(queue[CollectionEnumeratorLike_peek], expectEquals(3));
    for (let i = 8; i < 16; i++) {
        queue[QueueableLike_enqueue](i);
        pipe(queue[CollectionEnumeratorLike_peek], expectEquals(3));
    }
    pipe((queue[SyncEnumeratorLike_moveNext](), queue[EnumeratorLike_current]), expectEquals(3));
    pipe(queue[CollectionEnumeratorLike_peek], expectEquals(4));
    pipe((queue[SyncEnumeratorLike_moveNext](), queue[EnumeratorLike_current]), expectEquals(4));
    pipe(queue[CollectionEnumeratorLike_peek], expectEquals(5));
    pipe((queue[SyncEnumeratorLike_moveNext](), queue[EnumeratorLike_current]), expectEquals(5));
    ...
    queue[DisposableLike_dispose]();
    for (let i = 0; i < 3; i++) {
        pipe(queue[SyncEnumeratorLike_moveNext](), expectTrue("expected enumerator to have value"));
        pipe(queue[EnumeratorLike_current], expectEquals(i));
    }
    pipe(queue[SyncEnumeratorLike_moveNext](), expectFalse("expected enumerator to been consumed"));
}))();
