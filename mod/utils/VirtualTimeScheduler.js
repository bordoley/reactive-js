...
import { DisposableLike_dispose, EventListenerLike_notify, QueueLike_count, QueueLike_dequeue, QueueLike_head, SchedulerLike_maxYieldInterval, SchedulerLike_now, VirtualTimeSchedulerLike_run, } from "../utils.js";
        ...
        while (((queue = this[VirtualTimeScheduler_queue]),
            ...
            while (((continuation = queue[QueueLike_dequeue]()), isSome(continuation))) {
                if (continuation[SchedulerContinuationLike_dueTime] > currentTime) {
                    ...
                    this[VirtualTimeScheduler_queue][EventListenerLike_notify](continuation);
