...
declare function newInstance<TA, T>(Constructor: Constructor1<TA, T>, a: TA): T;
declare function newInstance<TA, TB, T>(Constructor: Constructor2<TA, TB, T>, a: TA, b: TB): T;
declare function newInstance<TA, TB, TC, T>(Constructor: Constructor3<TA, TB, TC, T>, a: TA, b: TB, c: TC): T;
declare function newInstance<TA, TB, TC, TD, T>(Constructor: Constructor4<TA, TB, TC, TD, T>, a: TA, b: TB, c: TC, d: TD): T;
...
declare function instanceFactory<TA, T>(Constructor: Constructor1<TA, T>): Function1<TA, T>;
declare function instanceFactory<TA, TB, T>(Constructor: Constructor2<TA, TB, T>): Function2<TA, TB, T>;
declare function instanceFactory<TA, TB, TC, T>(Constructor: Constructor3<TA, TB, TC, T>): Function3<TA, TB, TC, T>;
