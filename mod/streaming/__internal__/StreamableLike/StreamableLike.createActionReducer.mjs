...
const StreamableLike__createActionReducer = (reducer, initialState, options) => StreamableLike__createLifted(obs => ObservableLike__create(observer => {
    ...
    pipe(obs, ObservableLike__scan(reducer, returns(acc)), ContainerLike__concatWith({ concat: ObservableLike__merge }, pipe([acc], ReadonlyArrayLike__toRunnableObservable())), ObservableLike__distinctUntilChanged(options), ReactiveContainerLike__sinkInto(observer));
}));
