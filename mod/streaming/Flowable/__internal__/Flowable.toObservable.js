...
const Flowable_toObservable = () => src => {
    ...
    return create(observer => {
        ...
        const op = compose(Observable_forEach(Queueable_pushTo(dispatcher)), Observable_ignoreElements(), 
        ...
        pipe(Stream_create(op, scheduler), Stream_sourceFrom(src), Disposable_addTo(observer), Disposable_onComplete(() => observer[ObserverLike_dispatcher][DispatcherLike_complete]()));
    });
};
