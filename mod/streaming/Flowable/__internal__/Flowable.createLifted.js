...
const Flowable_createLifted = (op, isRunnable) => Streamable_createLifted(compose(Observable_scan(updateReducer, returns(PauseableState_paused)), Observable_distinctUntilChanged(), op), false, false, isRunnable);
