...
import { PauseableState_paused, PauseableState_running } from '../../../scheduling.mjs';
...
const Flowable_toObservable = () => src => Observable_create(observer => {
    ...
    }, returns(PauseableState_paused), returns(PauseableState_running)), Observable_onSubscribe(() => dispatcher));
