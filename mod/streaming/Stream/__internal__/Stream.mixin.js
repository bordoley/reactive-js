...
const Stream_mixin = /*@__PURE__*/ (() => returns(mix(include(Dispatcher_delegatingMixin(), MulticastObservable_delegatingMixin()), function StreamMixin(instance, op, scheduler, multicastOptions) {
