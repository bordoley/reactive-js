...
import { FromEnumerable, GenerateAsync, ObservableLike, ScanLast, ToEnumerable, ToObservable, ToRunnable } from "../rx.js";
...
export declare const scanLast: ScanLast<AsyncEnumerableLike, ObservableLike>["scanLast"];
