...
], ReadonlyArray.values(), Enumerable.concatAll(), Enumerable.toReadonlyArray(), expectArrayEquals([1, 2, 3, 4, 5, 6])))), describe("concatMap", test("maps each value to a container and flattens", pipeLazy([0, 1], ReadonlyArray.values(), Enumerable.concatMap(pipeLazy([1, 2, 3], ReadonlyArray.values())), Enumerable.toReadonlyArray(), expectArrayEquals([1, 2, 3, 1, 2, 3])))));
((_) => { })(Enumerable);
