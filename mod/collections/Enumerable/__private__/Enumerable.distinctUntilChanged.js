...
/*@__PURE__*/ (() => {
    ...
    const createDistinctUntilChangedEnumerator = mixInstanceFactory(include(DelegatingEnumeratorMixin()), function DistinctUntilChangedEnumerator(instance, delegate, equality) {
