...
import { Computation, Computation_T, Computation_type, PureDeferredComputationModule } from "../computations.js";
 ...
 * @noInheritDoc
 */
export interface EnumerableModule extends PureDeferredComputationModule<EnumerableComputation> {
