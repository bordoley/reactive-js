...
declare const decorateGetter: (property: PropertyKey, get: () => unknown) => <TConstructor extends AnyConstructor>(Constructor: TConstructor) => TConstructor;
declare const decorateProperty: (property: PropertyKey, description: {
    get: (this: any) => unknown;
    set: (this: any, value: any) => void;
}) => <TConstructor extends AnyConstructor>(Constructor: TConstructor) => TConstructor;
declare const decorateMethod: (property: PropertyKey, f: (this: any, ...args: readonly any[]) => unknown) => <TConstructor extends AnyConstructor>(Constructor: TConstructor) => TConstructor;
export { Mixin, Mixin1, Mixin2, Mixin3, decorateGetter, decorateMethod, decorateProperty };
