...
import { MulticastObservableLike, ReadonlyObjectMapLike, ReplayObservableLike } from "../types.js";
 ...
 * @noInheritDoc
 */
export interface WindowLocationLike extends ReplayObservableLike<WindowLocationURI> {
