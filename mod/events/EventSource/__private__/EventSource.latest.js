...
const EventSource_latest = /*@__PURE__*/ (() => {
    ...
    const createLatestEventListener = mixInstanceFactory(include(DisposableMixin), function LatestEventListener(instance, ctx) {
        init(DisposableMixin, instance);
        instance[LatestEventListener_ctx] = ctx;
        pipe(instance, DisposableContainer.onComplete(onLatestEventListenerCompleted));
        return instance;
    }, props({
