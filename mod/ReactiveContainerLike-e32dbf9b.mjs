...
const createUsing = (m) => (resourceFactory, sourceFactory) => pipe((sink) => {
    pipe(resourceFactory(), resources => (Array.isArray(resources) ? resources : [resources]), forEach(addTo(sink)), resources => sourceFactory(...resources), sinkInto(sink));
}, create(m));
const createNever = (m) => {
...
export { DefaultObservable as D, EnumerableObservable as E, MulticastObservableLike_observerCount as M, ObservableLike_observableType as O, RunnableObservable as R, SubjectLike_publish as S, ReactiveContainerLike_sinkInto as a, sourceFrom as b, createRunnable as c, emptyRunnable as d, emptyRunnableT as e, createObservable as f, MulticastObservableLike_replay as g, createSubject as h, createObservableUsing as i, createObservableUsingT as j, deferObservable as k, deferObservableT as l, neverObservableT as m, neverObservable as n, createRunnableUsing as o, createRunnableUsingT as p, neverRunnable as q, neverRunnableT as r, sinkInto as s };
