...
const PauseableObservable_keepWithKey = ((predicate) => (obs) => pipe(obs, PauseableObservable_scan(([cnt, _], next) => tuple(cnt + 1, next), () => tuple(-1, none)), PauseableObservable_keep(([cnt, v]) => predicate(v, cnt))));
