...
export const fromEnumerable = Observable_toEventSource;
export const fromFactory = EventSource_fromFactory;
export const fromOptional = EventSource_fromOptional;
export const fromReadonlyArray = ReadonlyArray_toEventSource;
