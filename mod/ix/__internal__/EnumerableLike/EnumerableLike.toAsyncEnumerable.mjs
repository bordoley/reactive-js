...
/*@__PURE__*/ (() => returns((enumerable) => AsyncEnumerableLike__create(observable => ObservableLike__create(observer => {
    ...
    pipe(observable, ObservableLike__map(_ => SourceLike__move(enumerator)), ObservableLike__takeWhile(EnumeratorLike__hasCurrent), ObservableLike__map(EnumeratorLike__getCurrent), ReactiveContainerLike__sinkInto(observer));
}))))();
