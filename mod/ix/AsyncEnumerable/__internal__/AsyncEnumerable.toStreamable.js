/// <reference types="./AsyncEnumerable.toStreamable.d.ts" />
...
const AsyncEnumerable_toStreamable = () => (enumerable) => Streamable_createLifted(obs => Observable_create(observer => {
    const enumerator = pipe(enumerable, Enumerable_enumerate(), Disposable_addTo(observer));
    pipe(obs, Observable_concatMap(_ => {
