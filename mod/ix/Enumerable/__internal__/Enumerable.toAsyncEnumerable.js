...
/*@__PURE__*/ returns((enumerable) => AsyncEnumerable_create(observable => Observable_create(observer => {
    ...
    pipe(observable, Observable_map(_ => Source_move(enumerator)), Observable_takeWhile(Enumerator_hasCurrent), Observable_map(Enumerator_getCurrent), Observable_observeWith(observer));
})));
