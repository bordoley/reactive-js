...
import { error, none, partial, pipe, strictEquality, } from "../../../functions.js";
...
/*@__PURE__*/ (() => {
    const DistinctUntilChangedEnumerator_delegate = Symbol("DistinctUntilChangedEnumerator_delegate");
    ...
    const createDistinctUntilChangedEnumerator = createInstanceFactory(mix(include(DisposableMixin), function DistinctUntilChangedEnumerator(instance, delegate, equality) {
        ...
        get [EnumeratorLike_current]() {
            unsafeCast(this);
            return this[DistinctUntilChangedEnumerator_delegate][EnumeratorLike_current];
        },
        get [EnumeratorLike_hasCurrent]() {
            unsafeCast(this);
            return this[DistinctUntilChangedEnumerator_delegate][EnumeratorLike_hasCurrent];
        },
        [EnumeratorLike_move]() {
