...
interface Defer<C extends LiftableLike> extends Container<C> {
...
export { CatchError, DecodeWithCharset, Defer, FromIterable, FromIterator, LiftableLike, LiftableStateOf, ThrowIfEmpty, Using, encodeUtf8, genMap };
