...
export interface ComputationModule<TComputationType extends ComputationType, TCreationOptions extends {
    ...
    gen<T>(factory: Factory<Generator<T>>, options?: TCreationOptions["gen"]): GeneratorConstructor<TComputationType, T>;
