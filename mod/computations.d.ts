...
export type StatefulSynchronousComputationOperator<TComputation extends ComputationType, TA, out TB, TInComputationBaseOf extends ComputationBaseOf<TComputation, TA> = ComputationBaseOf<TComputation, TA>> = <TComputationOf extends TInComputationBaseOf>(computation: TComputationOf) => TComputationOf extends PureSynchronousComputationOf<TComputation, TA> ? PureSynchronousComputationOf<TComputation, TB> : TComputationOf extends SynchronousComputationWithSideEffectsOf<TComputation, TA> ? SynchronousComputationWithSideEffectsOf<TComputation, TB> : TComputationOf extends SynchronousComputationOf<TComputation, TA> ? SynchronousComputationOf<TComputation, TB> : TComputationOf extends DeferredComputationWithSideEffectsOf<TComputation, TA> ? DeferredComputationWithSideEffectsOf<TComputation, TB> : PureDeferredComputationOf<TComputation, TB>;
...
export interface SynchronousComputationModule<TComputation extends ComputationType> extends ComputationModule<TComputation> {
    ...
    repeat<T>(predicate: Predicate<number>): StatefulSynchronousComputationOperator<TComputation, T, T, DeferredComputationOf<TComputation, T>>;
    repeat<T>(count: number): StatefulSynchronousComputationOperator<TComputation, T, T, DeferredComputationOf<TComputation, T>>;
    repeat<T>(): StatefulSynchronousComputationOperator<TComputation, T, T, DeferredComputationOf<TComputation, T>>;
    retry<T>(shouldRetry?: (count: number, error: Error) => boolean): StatefulSynchronousComputationOperator<TComputation, T, T, DeferredComputationOf<TComputation, T>>;
