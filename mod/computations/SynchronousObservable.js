...
export const compute = Observable_computeSynchronous;
export const concat = Observable_concat;
export const concatAll = Observable_concatAll;
export const currentTime = SynchronousObservable_currentTime;
export const decodeWithCharset = Observable_decodeWithCharset;
export const delay = SynchronousObservable_delay;
...
export const keyFrame = SynchronousObservable_keyFrame;
...
export const toRunnable = SynchronousObservable_toRunnable;
