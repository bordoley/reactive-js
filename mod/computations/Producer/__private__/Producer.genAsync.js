...
const genFactory = (factory) => async (consumer) => {
    const enumerator = pipe(factory(), AsyncIterator.toAsyncEnumerator(), Disposable.addTo(consumer));
    let isActive = false;
...
export const Producer_genAsync = (factory => Source.create(genFactory(factory), {
    [ComputationLike_isPure]: false,
    [ComputationLike_isSynchronous]: false,
}));
export const Producer_genPureAsync = (factory => Source.create(genFactory(factory), {
