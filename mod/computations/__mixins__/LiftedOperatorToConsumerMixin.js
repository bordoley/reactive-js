...
import { LiftedOperatorLike_subscription, } from "../__internal__/LiftedSource.js";
...
const LiftedOperatorToConsumerMixin = /*@__PURE__*/ (() => {
    return returns(mix(include(LiftedOperatorToSinkMixin()), function LiftedOperatorToConsumerMixin(operator) {
        ...
        get [QueueableLike_isReady]() {
            unsafeCast(this);
            return this[LiftedOperatorToEventListenerLike_operator][LiftedOperatorLike_subscription][QueueableLike_isReady];
        },
        get [QueueableLike_backpressureStrategy]() {
            unsafeCast(this);
            return this[LiftedOperatorToEventListenerLike_operator][LiftedOperatorLike_subscription][QueueableLike_backpressureStrategy];
        },
        get [QueueableLike_capacity]() {
            unsafeCast(this);
            return this[LiftedOperatorToEventListenerLike_operator][LiftedOperatorLike_subscription][QueueableLike_capacity];
        },
        [QueueableLike_addOnReadyListener](callback) {
            return this[LiftedOperatorToEventListenerLike_operator][LiftedOperatorLike_subscription][QueueableLike_addOnReadyListener](callback);
        },
    })));
})();
