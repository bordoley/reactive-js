...
import { EventListenerLike, EventListenerLike_notify, SinkLike } from "../../utils.js";
...
type TReturn<TSubscription extends SinkLike, T> = LiftedSinkToEventListenerLike<TSubscription, T>;
