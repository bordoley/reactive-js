...
declare const LiftedOperatorToConsumerMixin: <TSubscription extends ConsumerLike, T>() => Mixin1<TReturn<TSubscription, T>, LiftedSinkLike<TSubscription, T>, TPrototype<TSubscription, T>>;
