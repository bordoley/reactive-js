...
import { BackPressureConfig_capacity, BackPressureConfig_strategy, BackpressureStrategy, ConsumerLike, FlowControllerLike_addOnReadyListener, FlowControllerLike_isReady } from "../../utils.js";
...
type TPrototype<TSubscription extends ConsumerLike, T> = Pick<LiftedSinkToConsumerLike<TSubscription, T>, typeof FlowControllerLike_isReady | typeof BackPressureConfig_strategy | typeof BackPressureConfig_capacity | typeof FlowControllerLike_addOnReadyListener>;
