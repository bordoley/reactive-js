...
import { DisposableLike, EventListenerLike_notify, SinkLike_complete } from "../../utils.js";
...
type TPrototype<TSubscription extends DisposableLike, TA, TB = TA> = Pick<DelegatingLiftedSinkLike<TSubscription, TA, TB>, typeof EventListenerLike_notify | typeof SinkLike_complete | typeof DelegatingLiftedSinkLike_onCompleted>;
