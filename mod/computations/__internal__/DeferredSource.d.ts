import { ComputationLike_isDeferred, ComputationLike_isPure, ComputationLike_isSynchronous, ComputationModule, HigherOrderInnerComputationLike, IterableLike, PickComputationModule, SourceLike } from "../../computations.js";
...
export declare const createTakeLast: <TComputationModule extends PickComputationModule<ComputationModule, "genPure">>(m: TComputationModule) => <TSink extends SinkLike<T>, T>(takeLast: (sink: TSink, count: number) => TSink & IterableLike<T>, options?: {
