/// <reference types="./DeferredReactiveSource.d.ts" />
...
import { LiftedReactiveSourceLike_sink, LiftedReactiveSourceLike_source, } from "./LiftedSource.js";
...
export const concat = (createDelegatingNotifyOnlyNonCompletingNonDisposingSink) => {
    ...
    const createConcatSource = mixInstanceFactory(function ConcatSource(sources) {
        ...
        [ReactiveSourceLike_subscribe](consumer) {
...
export const createLifted = /*@__PURE__*/ (() => {
    ...
    return mixInstanceFactory(function LiftedObservable(source, op, liftedSinkToConsumer, config) {
        ...
        [ReactiveSourceLike_subscribe](observer) {
            ...
            const destinationOp = pipeUnsafe(observer, Sink.toLiftedSink(), ...this[LiftedReactiveSourceLike_sink], this[LiftedSource_liftedSinkToConsumer]);
...
export const takeLast = (genPure, takeLast, options) => (obs) => create(consumer => {
    ...
    const takeLastSink = pipe(takeLast(count, consumer), Disposable.addTo(consumer), DisposableContainer.onComplete(() => genPure(bindMethod(takeLastSink, Symbol.iterator))[ReactiveSourceLike_subscribe](consumer)));
