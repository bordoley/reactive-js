...
const Observable_toProducer = ((options) => (observable) => DeferredEventSource.create(compose(Consumer.toObserver(options?.scheduler ?? DefaultScheduler.get()), bindMethod(observable, EventSourceLike_subscribe)), {
