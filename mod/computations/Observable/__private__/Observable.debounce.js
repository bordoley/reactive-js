...
const createDebounceSink = /*@__PURE__*/ (() => {
    ...
    return mixInstanceFactory(include(DelegatingLiftedSinkMixin()), function DebounceSink(delegate, durationFunction) {
        ...
        [EventListenerLike_notify](next) {
            ...
            this[DebounceSink_durationSubscription] = pipe(this[DebounceSink_durationFunction](next), Computation.endWith(m, none), Observable_takeFirst(), EventSource.subscribe(() => {
            ...
            }, { scheduler }), DisposableContainer.onComplete(() => {
