...
const Observable_scanMany = ((scanner, initialValue, innerType) => (source) => DeferredReactiveSource.create((observer) => {
    ...
    }), Observable_forEach(bindMethod(accFeedbackPublisher, EventListenerLike_notify)), invoke(ReactiveSourceLike_subscribe, observer));
