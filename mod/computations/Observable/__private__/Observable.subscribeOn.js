...
pipe(observable, Observable_enqueue(observer), Observable_subscribe(scheduler), Disposable.addTo(observer), DisposableContainer.onComplete(bindMethod(observer, SinkLike_complete))), {
