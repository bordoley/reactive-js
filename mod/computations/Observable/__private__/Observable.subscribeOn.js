...
const Observable_subscribeOn = ((scheduler, options) => (observable) => Observable_createWithConfig(observer => pipe(observable, Observable_enqueue(observer), Observable_subscribeWithConfig(scheduler, {
