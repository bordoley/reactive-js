...
const Observable_catchError = ((errorHandler, options) => pipe((delegate) => pipe(Observer_createWithDelegate(delegate), Disposable.addToContainer(delegate), DisposableContainer.onError(err => {
    let action = none;
    try {
