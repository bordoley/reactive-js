...
const Observable_fromStore = /*@__PURE__*/ (() => {
    ...
    return returns(mixInstanceFactory(include(DelegatingDisposableContainerMixin), function FromEventSourceObservable(store) {
        ...
        [ObservableLike_observe](observer) {
            ...
            pipe(this[FromStoreObservable_eventSource], DisposableContainer.onComplete(bindMethod(observer, SinkLike_complete)), DisposableContainer.onError(bindMethod(observer, DisposableLike_dispose)), EventSource.addEventHandler(bindMethod(observer, EventListenerLike_notify)), Disposable.addTo(observer));
        },
    }));
})();
