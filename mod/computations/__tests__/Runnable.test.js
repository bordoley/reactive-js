...
testModule("Runnable", ComputationModuleTests(Runnable, RunnableTypes), DeferredComputationModuleTests(Runnable, RunnableTypes), DeferredReactiveComputationModuleTests(Runnable, RunnableTypes), SynchronousComputationModuleTests(Runnable));
((_) => { })(Runnable);
