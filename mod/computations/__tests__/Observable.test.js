...
testModule("Observable", ComputationModuleTests(m), DeferredComputationModuleTests(m), ReactiveComputationModuleTests(m), DeferredReactiveComputationModuleTests(m))({
    beforeEach() {
