...
testModule("Iterable", ComputationModuleTests(Iterable), DeferredComputationModuleTests(Iterable), SynchronousComputationModuleTests(Iterable), InteractiveComputationModuleTests(Iterable));
