...
testModule("Iterable", ComputationModuleTests(Iterable, IterableTypes), SynchronousComputationModuleTests(Iterable), InteractiveComputationModuleTests(Iterable));
