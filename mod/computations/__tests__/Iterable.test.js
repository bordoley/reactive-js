...
testModule("Iterable", PureStatelesssComputationModuleTests(Iterable), DeferredComputationModuleTests(Iterable), ComputationWithSideEffectsModuleTests(Iterable), SynchronousComputationModuleTests(Iterable));
