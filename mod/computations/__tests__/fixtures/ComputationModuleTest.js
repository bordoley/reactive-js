...
})), describe("skipFirst", testAsync("with default count", pipeLazyAsync(bindMethod([1, 2, 3], Symbol.iterator), m.gen, m.skipFirst(), m.toReadonlyArrayAsync(), expectArrayEquals([2, 3]))), testAsync("when skipped source has additional elements", pipeLazyAsync(bindMethod([1, 2, 3], Symbol.iterator), m.gen, m.skipFirst({ count: 2 }), m.toReadonlyArrayAsync(), expectArrayEquals([3]))), testAsync("when all elements are skipped", pipeLazyAsync(bindMethod([1, 2, 3], Symbol.iterator), m.gen, m.skipFirst({ count: 4 }), m.toReadonlyArrayAsync(), expectArrayEquals([])))), describe("takeFirst", testAsync("with default count", pipeLazyAsync(bindMethod([1, 2, 3, 4, 5], Symbol.iterator), m.gen, m.takeFirst(), m.toReadonlyArrayAsync(), expectArrayEquals([1]))), testAsync("when taking fewer than the total number of elements in the source", pipeLazyAsync(bindMethod([1, 2, 3, 4, 5], Symbol.iterator), m.gen, m.takeFirst({ count: 3 }), m.toReadonlyArrayAsync(), expectArrayEquals([1, 2, 3]))), testAsync("when taking more than all the items produced by the source", pipeLazyAsync(bindMethod([1, 2], Symbol.iterator), m.gen, m.takeFirst({ count: 3 }), m.toReadonlyArrayAsync(), expectArrayEquals([1, 2]))), testAsync("from iterable source", pipeLazyAsync(bindMethod([1, 2, 3, 4], Symbol.iterator), m.gen, m.takeFirst({ count: 2 }), m.toReadonlyArrayAsync(), expectArrayEquals([1, 2]))), testAsync("when source is empty", pipeLazyAsync(bindMethod([], Symbol.iterator), m.gen, m.takeFirst({ count: 3 }), m.toReadonlyArrayAsync(), expectArrayEquals([]))), testAsync("with default count", pipeLazyAsync(bindMethod([1, 2, 3], Symbol.iterator), m.gen, m.takeFirst(), m.toReadonlyArrayAsync(), expectArrayEquals([1]))), testAsync("when count is 0", pipeLazyAsync(bindMethod([1, 2, 3], Symbol.iterator), m.gen, m.takeFirst({ count: 0 }), m.toReadonlyArrayAsync(), expectArrayEquals([])))), describe("takeWhile", testAsync("exclusive", async () => {
    await pipeAsync(bindMethod([1, 2, 3, 4, 5], Symbol.iterator), m.gen, m.takeWhile(lessThan(4)), m.toReadonlyArrayAsync(), expectArrayEquals([1, 2, 3]));
    await pipeAsync(bindMethod([1, 2, 3], Symbol.iterator), m.gen, m.takeWhile(alwaysTrue), m.toReadonlyArrayAsync(), expectArrayEquals([1, 2, 3]));
    await pipeAsync(bindMethod([], Symbol.iterator), m.gen, m.takeWhile(alwaysTrue), m.toReadonlyArrayAsync(), expectArrayEquals([]));
}), testAsync("inclusive", pipeLazyAsync(bindMethod([1, 2, 3, 4, 5, 6], Symbol.iterator), m.gen, m.takeWhile(lessThan(4), { inclusive: true }), m.toReadonlyArrayAsync(), expectArrayEquals([1, 2, 3, 4]))), testAsync("when predicate throws", async () => {
    const err = new Error();
    const predicate = (_) => {
        throw err;
    };
    await pipeAsync(pipeLazy(bindMethod([1, 1], Symbol.iterator), m.gen, m.takeWhile(predicate), m.toReadonlyArrayAsync()), expectToThrowErrorAsync(err));
})));
