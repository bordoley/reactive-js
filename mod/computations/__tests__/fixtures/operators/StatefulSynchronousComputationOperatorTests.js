...
const StatefulSynchronousComputationOperatorTests = (computationType, operator) => describe("StatefulSynchronousComputationOperator", computationType[Computation_pureSynchronousOfT] &&
    test("with PureSynchronous input, returns PureSynchronous output", pipeSomeLazy(computationType[Computation_pureSynchronousOfT], ComputationExpect.isPureSynchronous, operator, ComputationExpect.isPureSynchronous)), computationType[Computation_synchronousWithSideEffectsOfT] &&
