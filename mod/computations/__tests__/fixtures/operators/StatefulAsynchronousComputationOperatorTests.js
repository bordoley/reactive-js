/// <reference types="./StatefulAsynchronousComputationOperatorTests.d.ts" />
...
const StatefulAsynchronousComputationOperatorTests = (computationType, operator) => describe("StatefulAsynchronousComputationOperatorTests", computationType[Computation_pureSynchronousOfT] &&
    ...
    test("with Multicasted input, returns PureDeferred output", pipeSomeLazy(computationType[Computation_multicastOfT], ComputationExpect.isMulticasted, operator, ComputationExpect.isPureDeferred)));
