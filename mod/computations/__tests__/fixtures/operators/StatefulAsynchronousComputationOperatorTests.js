...
const StatefulAsynchronousComputationOperatorTests = (computations, operator) => describe("StatefulAsynchronousComputationOperatorTests", computations[Computation_pureSynchronousOfT] &&
    ...
    test("with Multicasted input, returns PureDeferred output", pipeSomeLazy(computations[Computation_multicastOfT], ComputationExpect.isMulticasted, operator, ComputationExpect.isPureDeferred)));
