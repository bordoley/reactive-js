...
const AlwaysReturnsDeferredComputationWithSideEffectsComputationOperatorTests = (computations, operator) => describe("AlwaysReturnsDeferredComputationWithSideEffectsComputationOperator", computations[Computation_pureSynchronousOfT] &&
    test("with PureSynchronous input, returns DeferredWithSideEffects output", pipeSomeLazy(computations[Computation_pureSynchronousOfT], ComputationExpect.isPureSynchronous, operator, ComputationExpect.isDeferredWithSideEffects, ComputationExpect.isNotSynchronous)), computations[Computation_synchronousWithSideEffectsOfT] &&
    ...
    test("with Multicasted input, returns DeferredWithSideEffects output", pipeSomeLazy(computations[Computation_multicastOfT], ComputationExpect.isMulticasted, operator, ComputationExpect.isDeferredWithSideEffects, ComputationExpect.isNotSynchronous)));
