import { ComputationOperatorWithSideEffects, ComputationType, Computation_deferredWithSideEffectsOfT, Computation_multicastOfT, Computation_pureDeferredOfT, Computation_pureSynchronousOfT, Computation_synchronousWithSideEffectsOfT, DeferredComputationWithSideEffectsOf, MulticastComputationOf, PureDeferredComputationOf, PureSynchronousComputationOf, SynchronousComputationWithSideEffectsOf } from "../../../../computations.js";
declare const ComputationOperatorWithSideEffectsTests: <TComputation extends ComputationType>(computationType: {
...
}, operator: ComputationOperatorWithSideEffects<TComputation, unknown, unknown>) => import("../../../../__internal__/testing.js").Describe;
