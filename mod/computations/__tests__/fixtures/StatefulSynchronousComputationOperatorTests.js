...
const StatefulSynchronousComputationOperatorTests = (computationType, operator) => {
    return describe("StatefulSynchronousComputationOperator", ...pipe([
        ...
        computationType[Computation_multicastOfT] &&
            test("with Multicasted input, returns PureDeferred output", pipeSomeLazy(computationType[Computation_multicastOfT], operator, ComputationExpect.isPureDeferred, ComputationExpect.isNotSynchronous)),
