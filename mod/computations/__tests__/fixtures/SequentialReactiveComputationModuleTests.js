...
const SequentialReactiveComputationModuleTests = (m) => describe("SequentialReactiveComputationModule", describe("buffer", testAsync("with multiple sub buffers", pipeLazyAsync([1, 2, 3, 4, 5, 6, 7, 8, 9], Computation.fromReadonlyArray(m), m.buffer({ count: 3 }), m.toProducer(), EventSource.toReadonlyArrayAsync(), expectArrayEquals([
    [1, 2, 3],
    [4, 5, 6],
    [7, 8, 9],
