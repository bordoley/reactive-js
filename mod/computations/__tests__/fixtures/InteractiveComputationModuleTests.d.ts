...
declare const InteractiveComputationModuleTests: <Type extends DeferredComputationLike & InteractiveComputationLike, TComputation extends Computation<Type>>(m: InteractiveComputationModule<Type, TComputation> & DeferredComputationModule<Type, TComputation> & ComputationModule<Type, TComputation> & {
