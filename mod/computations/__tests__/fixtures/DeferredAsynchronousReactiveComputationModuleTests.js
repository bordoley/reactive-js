/// <reference types="./DeferredAsynchronousReactiveComputationModuleTests.d.ts" />
...
const DeferredAsynchronousReactiveComputationModuleTests = (m) => describe("ComputationModule", describe("switchAll", testAsync("with empty source", pipeLazyAsync(Computation.empty(m)(), m.switchAll(PureDeferredComputation), Source.toReadonlyArrayAsync(), expectArrayEquals([]))) /*
testAsync(
