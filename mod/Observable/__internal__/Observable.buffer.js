...
const Observable_buffer = (options) => pipe(Observer_createBufferObserver, partial(clampPositiveNonZeroInteger(options?.count ?? MAX_SAFE_INTEGER)), Observable_liftEnumerableUpperBounded);
