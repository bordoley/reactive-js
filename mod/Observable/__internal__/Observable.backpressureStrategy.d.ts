...
type ObservableBackpressureStrategy = <C extends ObservableContainer.Type, T>(capacity: number, backpressureStrategy: QueueableLike[typeof QueueableLike_backpressureStrategy]) => Containers.Operator<C, T, T>;
