...
})), describe("scanAsync", test("fast lib, slow acc", pipeLazy([1, 2, 3], fromArray$3(), scanAsync$1((acc, x) => fromValue(fromArrayT, { delay: 4 })(x + acc), returns(0)), toRunnable(), toArray(), expectArrayEquals([1, 3, 6]))), test("slow lib, fast acc", pipeLazy([1, 2, 3], fromArray$3({ delay: 4 }), scanAsync$1((acc, x) => fromValue(fromArrayT)(x + acc), returns(0)), toRunnable(), toArray(), expectArrayEquals([1, 3, 6]))), test("slow lib, slow acc", pipeLazy([1, 2, 3], fromArray$3({ delay: 4 }), scanAsync$1((acc, x) => fromValue(fromArrayT, { delay: 4 })(x + acc), returns(0)), toRunnable(), toArray(), expectArrayEquals([1, 3, 6]))), test("fast lib, fast acc", pipeLazy([1, 2, 3], fromArray$3(), scanAsync$1((acc, x) => fromValue(fromArrayT)(x + acc), returns(0)), toRunnable(), toArray(), expectArrayEquals([1, 3, 6])))), test("share", () => {
    const scheduler = createVirtualTimeScheduler();
