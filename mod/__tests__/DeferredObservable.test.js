...
testModule("DeferredObservable", HigherOrderObservableTypeClassTests(DeferredObservable, identityLazy), describe("share", test("shared observable zipped with itself", () => {
