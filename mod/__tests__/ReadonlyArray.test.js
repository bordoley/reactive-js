...
testModule("ReadonlyArray", ...ReactiveContainerModuleTests(ReadonlyArray, returns(Disposable.disposed), identityLazy, identityLazy), ...IndexedCollectionContainerModuleTests(ReadonlyArray));
((_) => { })(ReadonlyArray);
