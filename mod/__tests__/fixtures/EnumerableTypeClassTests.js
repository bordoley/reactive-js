...
const EnumerableTypeClassTests = (m) => describe("EnumerableTypeClass", ...RunnableTypeClassTests(m).tests, describe("enumerate", test("with higher order observable and no delay", () => {
