...
const EnumerableTypeClassTests = (m) => describe("EnumerableTypeClass", ...RunnableTypeClassTests(m), describe("enumerate", test("with higher order observable and no delay", () => {
