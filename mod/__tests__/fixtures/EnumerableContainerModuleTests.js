...
import { describe, expectArrayEquals, expectFalse, expectIsNone, expectTrue, test, } from "../../__internal__/testing.js";
import { identity, pipe, pipeLazy, returns } from "../../functions.js";
import { DisposableLike_error, DisposableLike_isDisposed, EnumeratorLike_hasCurrent, EnumeratorLike_move, ObservableLike_isDeferred, ObservableLike_isEnumerable, ObservableLike_isRunnable, } from "../../types.js";
...
const EnumerableContainerModuleTests = (m) => [
    ...
    describe("EnumerableContainerModule", describe("empty", test("returns an empty enumerator", () => {
        ...
        pipe(obs, Observable.withCurrentTime(identity), Runnable.toReadonlyArray(), expectArrayEquals([0, 1, 2]));
    }))),
];
