...
const HigherOrderObservableTypeClassTests = (m, fromRunnable) => describe("HigherOrderObservableTypeClass", describe("catchError", testAsync("when source throws", async () => {
    const e = {};
