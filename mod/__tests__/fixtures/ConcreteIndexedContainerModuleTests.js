/// <reference types="./ConcreteIndexedContainerModuleTests.d.ts" />
...
const ConcreteIndexedContainerModuleTests = (m, createCtx, toReadonlyArray) => [
    IndexedContainerModuleTests(m, createCtx, () => m.fromReadonlyArray(), toReadonlyArray),
