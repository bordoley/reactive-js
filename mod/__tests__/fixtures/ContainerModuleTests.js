...
})), describe("skipFirst", test("when skipped source has additional elements", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3], fromReadonlyArray(ctx), m.skipFirst({ count: 2 }), toReadonlyArray(ctx), expectArrayEquals([3])))), test("when all elements are skipped", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3], fromReadonlyArray(ctx), m.skipFirst({ count: 4 }), toReadonlyArray(ctx), expectArrayEquals([]))))), describe("takeFirst", test("when taking fewer than the total number of elements in the source", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3, 4, 5], fromReadonlyArray(ctx), m.takeFirst({ count: 3 }), toReadonlyArray(ctx), expectArrayEquals([1, 2, 3])))), test("when taking more than all the items produced by the source", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2], fromReadonlyArray(ctx), m.takeFirst({ count: 3 }), toReadonlyArray(ctx), expectArrayEquals([1, 2])))), test("when source is empty", Disposable.usingLazy(createCtx)((ctx) => pipe([], fromReadonlyArray(ctx), m.takeFirst({ count: 3 }), toReadonlyArray(ctx), expectArrayEquals([])))), test("with default count", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3], fromReadonlyArray(ctx), m.takeFirst(), toReadonlyArray(ctx), expectArrayEquals([1])))), test("when count is 0", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3], fromReadonlyArray(ctx), m.takeFirst({ count: 0 }), toReadonlyArray(ctx), expectArrayEquals([]))))), describe("takeLast", test("when count is less than the total number of elements", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3, 4, 5], fromReadonlyArray(ctx), m.takeLast({ count: 3 }), toReadonlyArray(ctx), expectArrayEquals([3, 4, 5])))), test("when count is greater than the total number of elements", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3, 4, 5], fromReadonlyArray(ctx), m.takeLast({ count: 10 }), toReadonlyArray(ctx), expectArrayEquals([1, 2, 3, 4, 5])))), test("with default count", Disposable.usingLazy(createCtx)((ctx) => pipe([1, 2, 3, 4, 5], fromReadonlyArray(ctx), m.takeLast(), toReadonlyArray(ctx), expectArrayEquals([5]))))), describe("takeWhile", test("exclusive", () => {
