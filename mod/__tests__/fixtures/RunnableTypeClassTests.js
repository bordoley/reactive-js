...
const RunnableTypeClassTests = (m) => describe("RunnableTypeClass", ...ContainerTypeClassTests(m, m.fromReadonlyArray, m.toReadonlyArray).tests, describe("concat", test("concats the input containers in order", pipeLazy(m.concat(pipe([1, 2, 3], m.fromReadonlyArray()), pipe([4, 5, 6], m.fromReadonlyArray())), m.toReadonlyArray(), expectArrayEquals([1, 2, 3, 4, 5, 6])))), describe("concatAll", test("concats the input containers in order", pipeLazy([
