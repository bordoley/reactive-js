import { Buffer, CatchError, Concat, ConcatAll, ContainerLike, DecodeWithCharset, Defer, DistinctUntilChanged, EverySatisfy, ForEach, FromIterable, FromReadonlyArray, Keep, Map, Pairwise, Reduce, Repeat, Scan, SkipFirst, SomeSatisfy, TakeFirst, TakeLast, TakeWhile, ThrowIfEmpty, ToReadonlyArray, Zip } from "../containers.js";
...
export declare const catchErrorTests: <C extends ContainerLike>(m: CatchError<C, never> & Map<C, never> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const concatMapTests: <C extends ContainerLike>(m: ConcatAll<C, never> & FromReadonlyArray<C, unknown> & Map<C, never> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
export declare const concatWithTests: <C extends ContainerLike>(m: Concat<C> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
export declare const decodeWithCharsetTests: <C extends ContainerLike>(m: DecodeWithCharset<C, unknown> & Defer<C, never> & FromReadonlyArray<C, unknown> & Map<C, never> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const endWithTests: <C extends ContainerLike>(m: Concat<C> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const genMapTests: <C extends ContainerLike>(m: ConcatAll<C, never> & FromReadonlyArray<C, unknown> & FromIterable<C, never> & Map<C, never> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
export declare const ignoreElementsTests: <C extends ContainerLike>(m: Keep<C, never> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const mapToTests: <C extends ContainerLike>(m: Map<C, never> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const retryTests: <C extends ObservableLike<unknown>>(m: Concat<C> & Retry<C> & FromReadonlyArray<C, unknown> & Map<C, never> & TakeFirst<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const someSatisfyTests: <C extends ContainerLike>(m: SomeSatisfy<C, never> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
export declare const startWithTests: <C extends ContainerLike>(m: Concat<C> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
...
export declare const toRunnableObservableTests: <C extends ContainerLike>(m: FromReadonlyArray<C, unknown> & ToRunnableObservable<C, {
...
export declare const zipWithTests: <C extends ContainerLike>(m: Zip<C> & FromReadonlyArray<C, unknown> & ToReadonlyArray<C, never>) => import("./testing.js").Describe;
