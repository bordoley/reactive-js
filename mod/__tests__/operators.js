...
export const scanAsyncTests = (m, mInner) => describe("scanAsync", test("fast lib, slow acc", pipeLazy([1, 2, 3], m.fromReadonlyArray(), m.scanAsync((acc, x) => pipe([x + acc], mInner.fromReadonlyArray({ delay: 4 })), returns(0)), m.toRunnable(), Runnable.toReadonlyArray(), expectArrayEquals([1, 3, 6]))), test("slow lib, fast acc", pipeLazy([1, 2, 3], m.fromReadonlyArray({ delay: 4 }), m.scanAsync((acc, x) => pipe([x + acc], mInner.fromReadonlyArray({ delay: 4 })), returns(0)), m.toRunnable(), Runnable.toReadonlyArray(), expectArrayEquals([1, 3, 6]))), test("slow lib, slow acc", pipeLazy([1, 2, 3], m.fromReadonlyArray({ delay: 4 }), m.scanAsync((acc, x) => pipe([x + acc], mInner.fromReadonlyArray({ delay: 4 })), returns(0)), m.toRunnable(), Runnable.toReadonlyArray(), expectArrayEquals([1, 3, 6]))), test("fast lib, fast acc", pipeLazy([1, 2, 3], m.fromReadonlyArray(), m.scanAsync((acc, x) => pipe([x + acc], mInner.fromReadonlyArray()), returns(0)), m.toRunnable(), Runnable.toReadonlyArray(), expectArrayEquals([1, 3, 6]))));
