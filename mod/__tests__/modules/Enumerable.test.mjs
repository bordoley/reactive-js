...
import { fromArray, buffer, toReadonlyArray, concat, concatAll, distinctUntilChanged, forEach, keep, map, pairwise, repeat, takeFirst, scan, skipFirst, takeLast, takeWhile, throwIfEmpty, zip } from '../../ix/Enumerable.mjs';
...
testModule("Enumerable", bufferTests({
    fromArray,
    buffer,
    toReadonlyArray,
}), concatTests({
