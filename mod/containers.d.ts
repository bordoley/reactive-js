 ...
 * @category TypeClass
 */
export interface Enumerate<C extends ContainerLike, CEnumerator extends EnumeratorLike = EnumeratorLike, O = never> {
    /**
     *
     * @category Transform
     */
    enumerate<T>(options?: O): Function1<ContainerOf<C, T>, ContainerOf<CEnumerator, T>>;
}
/**
 * @noInheritDoc
 * @category TypeClass
