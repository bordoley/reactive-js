 ...
 * @noInheritDoc
 */
export interface KeyedContainerTypeClass<C extends KeyedContainers> {
    /**
...
export interface AsynchronousTypeClass<C extends Container> {
    /**
     * @category Constructor
     */
...
export interface EnumerableTypeClass<C extends Container, CEnumerator extends EnumeratorContainer.Type = EnumeratorContainer.Type> {
    /**
     *
     * @category Transform
     */
...
export declare namespace DictionaryContainer {
    ...
    type TKey = KeyedContainers.KeyOf<Type>;
