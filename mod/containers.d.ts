...
export interface FirstAsync<C extends ContainerLike, O = never> {
     ...
     * @category Transform
     */
    firstAsync<T>(options?: O): Function1<ContainerOf<C, T>, PromiseableLike<Optional<T>>>;
}
/**
 * @noInheritDoc
 * @category TypeClass
...
export interface FromEnumeratorFactory<C extends ContainerLike, O = never> {
     ...
     * @category Constructor
     */
    fromEnumeratorFactory<T>(factory: Factory<EnumeratorLike<T>>, options?: O): ContainerOf<C, T>;
}
/**
 * @noInheritDoc
 * @category TypeClass
...
export interface LastAsync<C extends ContainerLike, O = never> {
     ...
     * @category Transform
     */
    lastAsync<T>(options?: O): Function1<ContainerOf<C, T>, PromiseableLike<Optional<T>>>;
}
/**
 * @noInheritDoc
 * @category TypeClass
...
export interface Reduce<C extends ContainerLike, O = never> {
     ...
     * @category Operator
     */
    reduce<T, TAcc>(reducer: Reducer<T, TAcc>, initialValue: Factory<TAcc>, options?: O): Function1<ContainerOf<C, T>, TAcc>;
}
/**
 * @noInheritDoc
 * @category TypeClass
