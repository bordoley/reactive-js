...
var Sequence = /*#__PURE__*/Object.freeze({
    __proto__: null,
    sequenceResultDone: sequenceResultDone,
    empty: empty,
    concatAll: concatAll,
    fromArray: fromArray,
    concat: concat,
...
export { Sequence as S, concat as a, concatWith as b, concatAll as c, distinctUntilChanged as d, empty as e, fromArray as f, endWith as g, mapTo as h, concatMap as i, startWith as j, keep as k, fromValue as l, map as m, generate as n, seek as o, scan as p, skipFirst as q, repeat as r, sequenceResultDone as s, takeFirst as t, takeLast as u, takeWhile as v, toRunnable as w };
