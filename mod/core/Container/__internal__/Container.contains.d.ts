...
declare const Container_contains: <C extends Container>(someSatisfy: <T>(predicate: import("../../../functions.js").Predicate<T>) => Function1<Container.Of<C, T>, boolean>) => <T_1>(value: T_1, options?: {
