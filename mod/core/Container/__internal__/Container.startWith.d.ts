...
declare const Container_startWith: <C extends Container>(concatWith: <T>(snd: Container.Of<C, T>, ...tail: readonly Container.Of<C, T>[]) => Container.Operator<C, T, T>, fromReadonlyArray: <T_1>(options?: {
