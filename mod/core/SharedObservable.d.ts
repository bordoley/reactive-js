import { Containers, DisposableLike, DisposableOrTeardown, ObservableLike, ObserverLike, QueueableLike, QueueableLike_backpressureStrategy, SchedulerLike, SharedObservableContainer, SharedObservableLike } from "../core.js";
 ...
 * @category Operator
 */
export declare const flatMapAsync: <TA, TB>(f: import("../functions.js").Function2<TA, AbortSignal, Promise<TB>>) => Containers.Operator<import("../core.js").ObservableContainer, TA, TB>;
