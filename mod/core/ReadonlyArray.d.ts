...
export declare const fromEnumerable: Container.FromEnumerable<ReadonlyArrayContainer>["fromEnumerable"];
...
export declare const fromRunnable: Container.FromRunnable<ReadonlyArrayContainer>["fromRunnable"];
