import { Container, Container_T, Container_type, Containers, DeferredContainers, DisposableLike, EnumerableContainer, EnumerableContainers, EnumeratorLike, RunnableContainers, StatefulContainers } from "../core.js";
export declare const buffer: Containers.TypeClass<EnumerableContainer>["buffer"];
export declare const catchError: StatefulContainers.TypeClass<EnumerableContainer>["catchError"];
/**
...
export declare const decodeWithCharset: StatefulContainers.TypeClass<EnumerableContainer>["decodeWithCharset"];
export declare const defer: StatefulContainers.TypeClass<EnumerableContainer>["defer"];
...
export declare const encodeUtf8: StatefulContainers.TypeClass<EnumerableContainer>["encodeUtf8"];
...
export declare const firstAsync: Containers.TypeClass<EnumerableContainer>["firstAsync"];
...
export declare const lastAsync: Containers.TypeClass<EnumerableContainer>["lastAsync"];
...
export declare const retry: StatefulContainers.TypeClass<EnumerableContainer>["retry"];
export declare const scan: Containers.TypeClass<EnumerableContainer>["scan"];
export declare const scanLast: Containers.TypeClass<EnumerableContainer>["scanLast"];
...
export declare const throws: StatefulContainers.TypeClass<EnumerableContainer>["throws"];
export declare const throwIfEmpty: StatefulContainers.TypeClass<EnumerableContainer>["throwIfEmpty"];
