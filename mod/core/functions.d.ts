 ...
 */
declare const compose: Compose["compose"];
interface PipeLazy {
 ...
 */
declare const pipeLazy: PipeLazy["pipeLazy"];
interface Flip {
    flip<TA, TB, T>(f: Function2<TA, TB, T>): Function2<TB, TA, T>;
    flip<TA, TB, TC, T>(f: Function3<TA, TB, TC, T>): Function3<TC, TB, TA, T>;
}
/**
 * Returns a function that flips the order of arguments passed to `f`.
 */
declare const flip: Flip["flip"];
...
declare const newInstance: NewInstance["newInstance"];
interface NewInstanceWith {
    newInstanceWith<T>(): Function1<Constructor<T>, T>;
    newInstanceWith<T, TA>(a: TA): Function1<Constructor1<TA, T>, T>;
    newInstanceWith<T, TA, TB>(a: TA, b: TB): Function1<Constructor2<TA, TB, T>, T>;
    newInstanceWith<T, TA, TB, TC>(a: TA, b: TB, c: TC): Function1<Constructor3<TA, TB, TC, T>, T>;
    newInstanceWith<T, TA, TB, TC, TD>(a: TA, b: TB, c: TC, d: TD): Function1<Constructor4<TA, TB, TC, TD, T>, T>;
}
declare const newInstanceWith: NewInstanceWith["newInstanceWith"];
interface InstanceFactory {
    instanceFactory<T>(Constructor: Constructor<T>): Factory<T>;
    instanceFactory<T, TA>(Constructor: Constructor1<TA, T>): Function1<TA, T>;
    instanceFactory<T, TA, TB>(Constructor: Constructor2<TA, TB, T>): Function2<TA, TB, T>;
    instanceFactory<T, TA, TB, TC>(Constructor: Constructor3<TA, TB, TC, T>): Function3<TA, TB, TC, T>;
}
declare const instanceFactory: InstanceFactory["instanceFactory"];
