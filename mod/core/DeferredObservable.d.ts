import { DeferredObservableContainer, DeferredObservableLike } from "../core.js";
...
export declare const create: <T>(f: import("../functions.js").SideEffect1<import("../core.js").ObserverLike<T>>) => DeferredObservableLike<T>;
