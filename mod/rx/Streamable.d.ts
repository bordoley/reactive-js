...
export declare const createAnimationGroupEventHandler: {
    ...
    <TEventType_3 = unknown, T_3 = number, TKey_3 extends string | number | symbol = string>(animationGroup: import("../keyed-containers.js").ReadonlyObjectMapLike<TKey_3, import("../functions.js").Function1<TEventType_3, import("../rx.js").AnimationConfig<T_3> | readonly import("../rx.js").AnimationConfig<T_3>[]>>): import("../rx.js").AnimationGroupEventHandlerLike<TEventType_3, T_3, TKey_3>;
};
/**
