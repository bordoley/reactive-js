...
import FlowableLike__toObservable from '../streaming/__internal__/FlowableLike/FlowableLike.toObservable.mjs';
...
const fromDisposable = DisposableLike__toObservable;
const fromFlowable = FlowableLike__toObservable;
