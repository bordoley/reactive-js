...
import EnumerableObservable$catchError from './__internal__/EnumerableObservable/EnumerableObservable.catchError.mjs';
import EnumerableObservable$create from './__internal__/EnumerableObservable/EnumerableObservable.create.mjs';
import EnumerableObservable$defer from './__internal__/EnumerableObservable/EnumerableObservable.defer.mjs';
import EnumerableObservable$mergeAll from './__internal__/EnumerableObservable/EnumerableObservable.mergeAll.mjs';
import EnumerableObservable$never from './__internal__/EnumerableObservable/EnumerableObservable.never.mjs';
import EnumerableObservable$scanAsync from './__internal__/EnumerableObservable/EnumerableObservable.scanAsync.mjs';
import EnumerableObservable$switchAll from './__internal__/EnumerableObservable/EnumerableObservable.switchAll.mjs';
...
const catchError = EnumerableObservable$catchError;
const concat = Observable$concat;
const concatAll = (options = {}) => {
    const { maxBufferSize = MAX_SAFE_INTEGER } = options;
    return mergeAll({ maxBufferSize, maxConcurrency: 1 });
};
const create = EnumerableObservable$create;
const decodeWithCharset = Observable$decodeWithCharset;
const defer = EnumerableObservable$defer;
...
const mergeAll = EnumerableObservable$mergeAll;
...
const scanAsync = EnumerableObservable$scanAsync;
const skipFirst = Observable$skipFirst;
const someSatisfy = Observable$someSatisfy;
const switchAll = EnumerableObservable$switchAll;
