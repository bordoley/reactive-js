...
interface CreateAnimationGroupEventHandler {
    createAnimationGroupEventHandler<TEventType, T = number, TKey extends string | symbol | number = string>(animationGroup: ReadonlyObjectMapLike<TKey, Function1<TEventType, Reactive.AnimationConfig<T> | readonly Reactive.AnimationConfig<T>[]>>, options: {
    ...
    createAnimationGroupEventHandler<T = number, TKey extends string | symbol | number = string>(animationGroup: ReadonlyObjectMapLike<TKey, Reactive.AnimationConfig<T> | readonly Reactive.AnimationConfig<T>[]>, options: {
        readonly mode: "switching";
        readonly scheduler?: SchedulerLike;
