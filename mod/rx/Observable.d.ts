import { CatchError, Concat, ConcatAll, ContainerOperator, DecodeWithCharset, Defer, DistinctUntilChanged, Empty, EverySatisfy, ForEach, ForkConcat, ForkZip, FromIterable, FromReadonlyArray, FromSequence, Generate, Keep, Map, Never, Pairwise, Reduce, Repeat, Scan, SkipFirst, SomeSatisfy, TakeFirst, TakeLast, TakeWhile, ThrowIfEmpty, Zip } from "../containers.js";
...
declare const Observable: {
    ...
    everySatisfy: <T_8>(predicate: import("../functions.js").Predicate<T_8>, options?: undefined) => ContainerOperator<ObservableLike<unknown>, T_8, boolean>;
    ...
    } | undefined) => Function1<import("../ix.js").EnumerableLike<T_10>, ObservableLike<T_10>>;
    fromFlowable: <T_11>(options?: undefined) => Function1<import("../streaming.js").FlowableLike<T_11>, ObservableLike<T_11>>;
    fromIterable: <T_12>(options?: {
        readonly delay?: number | undefined;
        readonly delayStart?: boolean | undefined;
    } | undefined) => Function1<Iterable<T_12>, ObservableLike<T_12>>;
    fromPromise: <T_13>(options?: undefined) => Function1<import("../containers.js").PromiseableLike<T_13>, ObservableLike<T_13>>;
    ...
    fromSequence: <T_15>(options?: {
        readonly delay?: number | undefined;
        readonly delayStart?: boolean | undefined;
    } | undefined) => Function1<import("../containers.js").SequenceLike<T_15>, ObservableLike<T_15>>;
    generate: <T_16>(generator: import("../functions.js").Updater<T_16>, initialValue: Factory<T_16>, options?: {
        readonly delay?: number | undefined;
        readonly delayStart?: boolean | undefined;
    ...
    keep: <T_17>(predicate: import("../functions.js").Predicate<T_17>, options?: undefined) => ContainerOperator<ObservableLike<unknown>, T_17, T_17>;
    ...
    pairwise: <T_20>(options?: undefined) => ContainerOperator<ObservableLike<unknown>, T_20, readonly [T_20, T_20]>;
    reduce: <T_21, TAcc>(reducer: import("../functions.js").Reducer<T_21, TAcc>, initialValue: Factory<TAcc>, options?: undefined) => ContainerOperator<ObservableLike<unknown>, T_21, TAcc>;
    repeat: {
        <T_22>(predicate: import("../functions.js").Predicate<number>, options?: undefined): ContainerOperator<ObservableLike<unknown>, T_22, T_22>;
    ...
    scan: <T_27, TAcc_1>(scanner: import("../functions.js").Reducer<T_27, TAcc_1>, initialValue: Factory<TAcc_1>, options?: undefined) => ContainerOperator<ObservableLike<unknown>, T_27, TAcc_1>;
    scanAsync: <T_28, TAcc_2>(scanner: import("../rx.js").AsyncReducer<ObservableLike<unknown>, T_28, TAcc_2>, initialValue: Factory<TAcc_2>) => ContainerOperator<ObservableLike<unknown>, T_28, TAcc_2>;
    ...
    someSatisfy: <T_31>(predicate: import("../functions.js").Predicate<T_31>, options?: undefined) => ContainerOperator<ObservableLike<unknown>, T_31, boolean>;
    ...
    takeWhile: <T_36>(predicate: import("../functions.js").Predicate<T_36>, options?: {
    ...
    zipLatest: {
        <TA_10, TB_10>(a: ObservableLike<TA_10>, b: ObservableLike<TB_10>): ObservableLike<readonly [TA_10, TB_10]>;
        <TA_11, TB_11, TC_7>(a: ObservableLike<TA_11>, b: ObservableLike<TB_11>, c: ObservableLike<TC_7>): ObservableLike<readonly [TA_11, TB_11, TC_7]>;
        <TA_12, TB_12, TC_8, TD_6>(a: ObservableLike<TA_12>, b: ObservableLike<TB_12>, c: ObservableLike<TC_8>, d: ObservableLike<TD_6>): ObservableLike<readonly [TA_12, TB_12, TC_8, TD_6]>;
        <TA_13, TB_13, TC_9, TD_7, TE_5>(a: ObservableLike<TA_13>, b: ObservableLike<TB_13>, c: ObservableLike<TC_9>, d: ObservableLike<TD_7>, e: ObservableLike<TE_5>): ObservableLike<readonly [TA_13, TB_13, TC_9, TD_7, TE_5]>;
        <TA_14, TB_14, TC_10, TD_8, TE_6, TF_4>(a: ObservableLike<TA_14>, b: ObservableLike<TB_14>, c: ObservableLike<TC_10>, d: ObservableLike<TD_8>, e: ObservableLike<TE_6>, f: ObservableLike<TF_4>): ObservableLike<readonly [TA_14, TB_14, TC_10, TD_8, TE_6, TF_4]>;
        <TA_15, TB_15, TC_11, TD_9, TE_7, TF_5, TG_3>(a: ObservableLike<TA_15>, b: ObservableLike<TB_15>, c: ObservableLike<TC_11>, d: ObservableLike<TD_9>, e: ObservableLike<TE_7>, f: ObservableLike<TF_5>, g: ObservableLike<TG_3>): ObservableLike<readonly [TA_15, TB_15, TC_11, TD_9, TE_7, TF_5, TG_3]>;
        <TA_16, TB_16, TC_12, TD_10, TE_8, TF_6, TG_4, TH_2>(a: ObservableLike<TA_16>, b: ObservableLike<TB_16>, c: ObservableLike<TC_12>, d: ObservableLike<TD_10>, e: ObservableLike<TE_8>, f: ObservableLike<TF_6>, g: ObservableLike<TG_4>, h: ObservableLike<TH_2>): ObservableLike<readonly [TA_16, TB_16, TC_12, TD_10, TE_8, TF_6, TG_4, TH_2]>;
        <TA_17, TB_17, TC_13, TD_11, TE_9, TF_7, TG_5, TH_3, TI_1>(a: ObservableLike<TA_17>, b: ObservableLike<TB_17>, c: ObservableLike<TC_13>, d: ObservableLike<TD_11>, e: ObservableLike<TE_9>, f: ObservableLike<TF_7>, g: ObservableLike<TG_5>, h: ObservableLike<TH_3>, i: ObservableLike<TI_1>): ObservableLike<readonly [TA_17, TB_17, TC_13, TD_11, TE_9, TF_7, TG_5, TH_3, TI_1]>;
    };
    zipWithLatestFrom: <TA_18, TB_18, T_44>(other: ObservableLike<TB_18>, selector: Function2<TA_18, TB_18, T_44>) => ContainerOperator<ObservableLike<unknown>, TA_18, T_44>;
};
