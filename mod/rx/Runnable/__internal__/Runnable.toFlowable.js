...
const Runnable_toFlowable = () => observable => Flowable_createLifted((modeObs) => Observable_create(observer => {
    ...
    }), Observable_subscribeWithCapacity(observer[DispatcherLike_scheduler], observer[QueueableLike_capacity]), Disposable_bindTo(pauseableScheduler))), Disposable_add(pauseableScheduler));
}), true);
