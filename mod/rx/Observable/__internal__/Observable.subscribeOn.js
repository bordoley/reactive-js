...
Observable_create(observer => pipe(observable, Observable_forEach(Queue_pushTo(observer[ObserverLike_dispatcher])), Observable_subscribe(scheduler), Disposable_bindTo(observer[ObserverLike_dispatcher])));
