...
Observable_create(observer => {
    ...
    const scheduler = isFunction(schedulerOrFactory)
        ...
        : schedulerOrFactory;
    pipe(observable, Observable_dispatchTo(observer), Observable_subscribeWithMaxBufferSize(scheduler, (_a = options === null || options === void 0 ? void 0 : options.maxBufferSize) !== null && _a !== void 0 ? _a : observer[QueueableLike_maxBufferSize]), Disposable_onComplete(bindMethod(observer, DispatcherLike_complete)), Disposable_addTo(observer));
});
