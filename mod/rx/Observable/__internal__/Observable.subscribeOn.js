...
Observable_create(observer => pipe(observable, Observable_forEach(Queueable_pushTo(observer)), Observable_subscribe(scheduler), Disposable_onComplete(() => observer[DispatcherLike_complete]()), Disposable_addTo(observer)));
