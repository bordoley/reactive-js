...
export const concatAll = RunnableObservable_concatAll;
export const concatMap = RunnableObservable_concatMap;
...
export const encodeUtf8 = RunnableObservable_encodeUtf8;
export const endWith = Observable_endWith;
export const everySatisfy = Observable_everySatisfy;
export const exhaust = RunnableObservable_exhaust;
export const exhaustMap = RunnableObservable_exhaustMap;
export const flatMapIterable = RunnableObservable_flatMapIterable;
...
export const switchMap = RunnableObservable_switchMap;
