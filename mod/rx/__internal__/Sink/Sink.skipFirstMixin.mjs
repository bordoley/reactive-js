...
/*@__PURE__*/ (() => {
    ...
    return returns(mix(include(Disposable$delegatingMixin), function SkipFirstSink(instance, delegate, skipCount) {
...
export { Sink$skipFirstMixin as default };
