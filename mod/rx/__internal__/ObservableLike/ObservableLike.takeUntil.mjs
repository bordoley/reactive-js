...
const ObservableLike__takeUntil = (notifier) => {
    const operator = (delegate) => pipe(ObserverLike__createWithDelegate(delegate), DisposableLike__bindTo(delegate), DisposableLike__bindTo(pipe(notifier, ObservableLike__takeFirst(), ObservableLike__subscribe(ObserverLike__getScheduler(delegate)))));
