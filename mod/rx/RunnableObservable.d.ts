...
declare const RunnableObservable: {
    ...
    map: <TA, TB>(mapper: Function1<TA, TB>) => ContainerOperator<RunnableObservableLike<unknown>, TA, TB>;
    ...
    never: <T_13>() => RunnableObservableLike<T_13>;
    pairwise: <T_14>() => ContainerOperator<RunnableObservableLike<unknown>, T_14, readonly [
        T_14,
        T_14
    ]>;
    reduce: <T_15, TAcc>(reducer: Reducer<T_15, TAcc>, initialValue: Factory<TAcc>) => ContainerOperator<RunnableObservableLike<unknown>, T_15, TAcc>;
    scan: <T_16, TAcc_1>(scanner: Reducer<T_16, TAcc_1>, initialValue: Factory<TAcc_1>) => ContainerOperator<RunnableObservableLike<unknown>, T_16, TAcc_1>;
    scanAsync: <T_17, TAcc_2>(scanner: AsyncReducer<RunnableObservableLike<unknown>, T_17, TAcc_2>, initialValue: Factory<TAcc_2>) => ContainerOperator<RunnableObservableLike<unknown>, T_17, TAcc_2>;
    skipFirst: <T_18>(options?: {
        readonly count?: number | undefined;
    } | undefined) => ContainerOperator<RunnableObservableLike<unknown>, T_18, T_18>;
    someSatisfy: <T_19>(predicate: Predicate<T_19>) => ContainerOperator<RunnableObservableLike<unknown>, T_19, boolean>;
    switchAll: <T_8>(options?: undefined) => ContainerOperator<RunnableObservableLike<unknown>, RunnableObservableLike<T_8>, T_8>;
    takeFirst: <T_20>(options?: {
        readonly count?: number | undefined;
    } | undefined) => ContainerOperator<RunnableObservableLike<unknown>, T_20, T_20>;
    takeLast: <T_21>(options?: {
        readonly count?: number | undefined;
    } | undefined) => ContainerOperator<RunnableObservableLike<unknown>, T_21, T_21>;
    takeWhile: <T_22>(predicate: Predicate<T_22>, options?: {
        readonly inclusive?: boolean | undefined;
    } | undefined) => ContainerOperator<RunnableObservableLike<unknown>, T_22, T_22>;
    throwIfEmpty: <T_23>(factory: Factory<unknown>) => ContainerOperator<RunnableObservableLike<unknown>, T_23, T_23>;
    toEnumerable: <T_24>(options?: undefined) => Function1<RunnableObservableLike<T_24>, EnumerableLike<T_24>>;
    toFlowable: <T_25>(options?: undefined) => Function1<RunnableObservableLike<T_25>, FlowableLike<T_25>>;
    toPromise: <T_26>(ctx: SchedulerLike) => Function1<RunnableObservableLike<T_26>, PromiseableLike<T_26>>;
    toReadonlyArray: <T_27>(options?: {
        readonly schedulerFactory: Factory<VirtualTimeSchedulerLike>;
    } | undefined) => Function1<RunnableObservableLike<T_27>, ReadonlyArrayLike<T_27>>;
    toRunnable: <T_28>(options?: undefined) => Function1<RunnableObservableLike<T_28>, RunnableLike<T_28>>;
    zip: {
        <TA_1, TB_1>(a: RunnableObservableLike<TA_1>, b: RunnableObservableLike<TB_1>): RunnableObservableLike<readonly [
            TA_1,
            TB_1
        ]>;
        <TA_2, TB_2, TC>(a: RunnableObservableLike<TA_2>, b: RunnableObservableLike<TB_2>, c: RunnableObservableLike<TC>): RunnableObservableLike<readonly [
            TA_2,
            TB_2,
            TC
        ]>;
        <TA_3, TB_3, TC_1, TD>(a: RunnableObservableLike<TA_3>, b: RunnableObservableLike<TB_3>, c: RunnableObservableLike<TC_1>, d: RunnableObservableLike<TD>): RunnableObservableLike<readonly [
            TA_3,
            TB_3,
            TC_1,
            TD
        ]>;
        <TA_4, TB_4, TC_2, TD_1, TE>(a: RunnableObservableLike<TA_4>, b: RunnableObservableLike<TB_4>, c: RunnableObservableLike<TC_2>, d: RunnableObservableLike<TD_1>, e: RunnableObservableLike<TE>): RunnableObservableLike<readonly [
            TA_4,
            TB_4,
            TC_2,
            TD_1,
        ...
        <TA_5, TB_5, TC_3, TD_2, TE_1, TF>(a: RunnableObservableLike<TA_5>, b: RunnableObservableLike<TB_5>, c: RunnableObservableLike<TC_3>, d: RunnableObservableLike<TD_2>, e: RunnableObservableLike<TE_1>, f: RunnableObservableLike<TF>): RunnableObservableLike<readonly [
            TA_5,
            TB_5,
            TC_3,
            TD_2,
        ...
        <TA_6, TB_6, TC_4, TD_3, TE_2, TF_1, TG>(a: RunnableObservableLike<TA_6>, b: RunnableObservableLike<TB_6>, c: RunnableObservableLike<TC_4>, d: RunnableObservableLike<TD_3>, e: RunnableObservableLike<TE_2>, f: RunnableObservableLike<TF_1>, g: RunnableObservableLike<TG>): RunnableObservableLike<readonly [
            TA_6,
            TB_6,
            TC_4,
            TD_3,
        ...
        <TA_7, TB_7, TC_5, TD_4, TE_3, TF_2, TG_1, TH>(a: RunnableObservableLike<TA_7>, b: RunnableObservableLike<TB_7>, c: RunnableObservableLike<TC_5>, d: RunnableObservableLike<TD_4>, e: RunnableObservableLike<TE_3>, f: RunnableObservableLike<TF_2>, g: RunnableObservableLike<TG_1>, h: RunnableObservableLike<TH>): RunnableObservableLike<readonly [
            TA_7,
            TB_7,
            TC_5,
            TD_4,
        ...
        <TA_8, TB_8, TC_6, TD_5, TE_4, TF_3, TG_2, TH_1, TI>(a: RunnableObservableLike<TA_8>, b: RunnableObservableLike<TB_8>, c: RunnableObservableLike<TC_6>, d: RunnableObservableLike<TD_5>, e: RunnableObservableLike<TE_4>, f: RunnableObservableLike<TF_3>, g: RunnableObservableLike<TG_2>, h: RunnableObservableLike<TH_1>, i: RunnableObservableLike<TI>): RunnableObservableLike<readonly [
            TA_8,
            TB_8,
            TC_6,
            TD_5,
