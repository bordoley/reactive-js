...
declare const Stream_mixin: <TReq, T>() => Mixin3<StreamLike<TReq, T> & DisposableLike, Container.Operator<DeferredObservableContainer.Type, TReq, T>, SchedulerLike, Optional<{
    replay?: number;
    capacity?: number;
