...
import { SequenceLike, Concat, ConcatAll, DistinctUntilChanged, ReadonlyArrayLike, FromArray, Generate, Keep, Map, Pairwise, Repeat, Scan, ContainerOperator, SkipFirst, TakeFirst, TakeLast, TakeWhile, ToReadonlyArray, Zip } from "../containers.js";
...
declare const fromArrayT: FromArray<SequenceLike>;
