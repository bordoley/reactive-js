/// <reference types="./AsyncIterable.toInteractiveObservable.d.ts" />
...
const AsyncIterable_toInteractiveObservable = (scheduler, options) => (iterable) => InteractiveObservable_create(observable => Observable_create(observer => {
