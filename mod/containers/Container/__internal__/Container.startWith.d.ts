...
declare const Container_startWith: <C extends Container>(concatWith: <T>(snd: import("../../../containers.js").ContainerOf<C, T>, ...tail: readonly import("../../../containers.js").ContainerOf<C, T>[]) => ContainerOperator<C, T, T>, fromReadonlyArray: <T_1>(options?: {
