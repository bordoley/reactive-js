import { ContainerLike, ContainerOperator, Map, Pick } from "../../../containers.js";
declare const Container_pick: <C extends ContainerLike>(map: <TA, TB>(selector: import("../../../functions.js").Function1<TA, TB>, options?: undefined) => ContainerOperator<C, TA, TB>) => {
