...
testModule("AsyncIterable", describe("toAsyncEnumerable", testAsync("infinite immediately resolving iterable", async () => {
    ...
    })(), AsyncIterable.toAsyncEnumerable(), AsyncEnumerable.toObservable(), Observable.takeFirst({ count: 10 }), Observable.buffer(), Observable.toPromise(scheduler));
    ...
    const result = await pipe((async function* foo() {
        ...
        yield 2;
        yield 3;
    })(), AsyncIterable.toAsyncEnumerable(), AsyncEnumerable.toObservable(), Observable.buffer(), Observable.toPromise(scheduler));
    ...
    const result = await pipe((async function* foo() {
        throw e;
    })(), AsyncIterable.toAsyncEnumerable(), AsyncEnumerable.toObservable(), Observable.catchError(e => pipe([e], Observable.fromReadonlyArray())), Observable.toPromise(scheduler));
