...
export const addEventHandler = Promise_addEventHandler;
export const toEventSource = Promise_toEventSource;
export const toObservable = Promise_toObservable;
export const toReadonlyArrayAsync = Promise_toReadonlyArrayAsync;
