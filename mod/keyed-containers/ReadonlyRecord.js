/// <reference types="./ReadonlyRecord.d.ts" />
...
export const empty = ReadonlyRecord_empty;
export const entries = ReadonlyRecord_entries;
export const forEachWithKey = ReadonlyRecord_forEachWithKey;
export const keep = ReadonlyRecord_keep;
export const keepType = ReadonlyRecord_keepType;
export const keepWithKey = ReadonlyRecord_keepWithKey;
export const keySet = ReadonlyRecord_keySet;
export const map = ReadonlyRecord_map;
export const mapWithKey = ReadonlyRecord_mapWithKey;
export const values = ReadonlyRecord_values;
