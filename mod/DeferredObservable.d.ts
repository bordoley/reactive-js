...
import { Container, Container_T, Container_type, DeferredObservableLike, DeferredTypeClass, DisposableLike, EnumerableLike, HigherOrderObservableTypeClass, MulticastObservableLike, QueueableLike, QueueableLike_backpressureStrategy, ReplayObservableLike, RunnableLike, SchedulerLike, StatefulTypeClass } from "./types.js";
 ...
 * @noInheritDoc
 */
export interface DeferredObservableModule extends DeferredTypeClass<Type>, HigherOrderObservableTypeClass<Type, Type>, StatefulTypeClass<Type> {
